...
<div class="panel-body">
    <div class="form-group">
        <textarea name="bulkdomains" rows="5" class="form-control">{$bulkdomains}</textarea>
    </div>
        {if $capatacha}
        ...
        {/if}
<p><input type="submit" value="{$LANG.checkavailability}" class="btn btn-primary" /></p>
</div></div>
</form>
