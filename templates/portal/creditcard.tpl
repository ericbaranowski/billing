...
{/foreach}
            ...
            <tr class="newccinfo"{if $cardnum && $ccinfo neq "new"} style="display:none;"{/if}>
              ...
              <td><select name="ccexpirymonth" id="ccexpirymonth">{foreach from=$months item=month}
...
{/foreach}
            ...
            <tr class="newccinfo"{if $cardnum && $ccinfo neq "new"} style="display:none;"{/if}>
              ...
              <td><select name="ccstartmonth" id="ccstartmonth">{foreach from=$months item=month}
