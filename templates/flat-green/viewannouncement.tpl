...
{if $twittertweet}
<br /><br />
<a href="https://twitter.com/share" class="twitter-share-button" data-count="large" data-via="{$twitterusername}">Tweet</a><script type="text/javascript" src="//platform.twitter.com/widgets.js"></script>
{/if}
