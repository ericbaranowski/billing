...
{$LANG.invoiceaddcreditamount}: <input type="text" name="creditamount" size="10" value="{$creditamount}" /> <input class="btn btn-primary" type="submit" value="{$LANG.invoiceaddcreditapply}" />
</div>
</form>
{/if}

<table class="address" cellspacing="8"><tr><td width="50%">
...
<div class="row">
  <div class="duedate"><strong>{$LANG.invoicesdatedue}:</strong> {$datedue}</div>
  <div class="date"><strong>{$LANG.invoicesdatecreated}:</strong> {$datecreated}</div>
