...
<form class="form-horizontal center95" method="post" action="{$smarty.server.PHP_SELF}">
...
<div class="col2half2" style="float:right;">
...
{else}
<p><img style="display: inline-block; margin: 0 0 -8px 0;" src="includes/verifyimage.php" align="middle" />&nbsp; <input type="text" name="code" size="10" maxlength="5" class="input-small" /></p>
{/if}
<div class="divider"></div>
{/if}
...
<p><input class="btn btn-large btn-primary" type="submit" value="{$LANG.clientregistertitle}" /></p>
