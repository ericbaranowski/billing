...
<div data-toggle="tab" id="tab1" class="tab-content active">
    ...
    <div class="row productdeets">
        ...
        <div class="col70 product-details">
                ...
                <div class="col2half">
                	<h4><strong>{$LANG.clientareahostingdomain}:</strong></h4> {$domain} &nbsp;&nbsp;<span style="color: #fff;" class="label {$rawstatus}">{$status}</span>
                </div>
            	<div class="col2half">
				...
				<div class="col2half">
                	<h4><strong>{$LANG.recurringamount}:</strong></h4> {$recurringamount} Every {$registrationperiod} {$LANG.orderyears}{if $renew}<br /> <br /><a href="cart.php?gid=renewals" class="btn btn-mini">{$LANG.domainsrenewnow}</a>{/if}
                </div>
                </div>
            	<div class="row">
            	<div class="col2half">
    ...
    <div class="row productdeets">
       ...
       <div class="col30" style="width: 25%;">
        ...
        <div class="col70 product-details">
                ...
                {else}
                <p><input type="submit" class="btn btn-success" value="{$LANG.domainreglockenable}" /></p>
                {/if}
                </form>
        </div>
...
<div class="col30" style="width: 25%;">
        ...
        <div class="col70 product-details">
                {if $releasedomain}
                <strong>&nbsp;&raquo;&nbsp;&nbsp;{$LANG.domainrelease}</strong>
                <form method="post" action="{$smarty.server.PHP_SELF}?action=domaindetails">
