...
<div class="product-details" style="float: none !important; padding: 2% !important;">
...
<div class="styled_title"><h4 style="margin: 20px 0 0 0; padding: 0;">{$LANG.creditcardenternewcard}</h4></div>
