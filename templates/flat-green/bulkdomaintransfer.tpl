...
<div class="subnav">
	<p><a href="domainchecker.php">{$LANG.domainsimplesearch}</a> | <a href="domainchecker.php?search=bulkregister">{$LANG.domainbulksearch}</a></p>
</div>	
{/if}
...
<div class="well">
    ...
    <div class="textcenter">
        ...
        {/if}
        <br />
        <input type="submit" value="{$LANG.domainstransfer}" class="btn btn-success btn-large" />
    </div>
</div>
