...
<div id="tab1" class="tab-content active">
    <div class="row">
        <div class="col-lg-4">
            <h2><span class="glyphicon glyphicon-info-sign"></span> {$LANG.information}</h2>
            <p><small>{$LANG.domaininfoexp}</small></p>
            <p><input type="button" value="{$LANG.backtodomainslist}" class="btn btn-default" onclick="window.location='clientarea.php?action=domains'" /></p>
        </div>
        <div class="col-lg-8">
...
<div id="tab2" class="tab-content">
    <div class="row">
        <div class="col-lg-4">
            <h2><span class="glyphicon glyphicon-repeat"></span> {$LANG.domainsautorenew}</h2>
...
<div id="tab3" class="tab-content">
    <div class="row">
        <div class="col-lg-4">
            <h2><span class="glyphicon glyphicon-list"></span> {$LANG.domainnameservers}</h2>
...
<div id="tab6" class="tab-content">
    <div class="row">
        <div class="col-lg-4">
            <h2><span class="glyphicon glyphicon-th"></span> {$LANG.domainaddons}</h2>
