        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="pull-right"><input type="button" value="{$LANG.backtoserviceslist}" class="btn btn-default" onclick="window.location='clientarea.php?action=products'" /></div>
                    <h2><span class="glyphicon glyphicon-info-sign"></span> {$LANG.information}</h2><p><small>{$LANG.clientareaproductdetailsintro}</small></p></div>
...
<div id="tab4" class="tab-content">
    <div class="row">
        <div class="col-lg-4">
            <h2><span class="glyphicon glyphicon-th"></span> {$LANG.clientareahostingaddons}</h2>
