...
<p><input type="button" value="{$LANG.clientareabacklink}" onclick="window.location='clientarea.php?action=productdetails&id={$id}'" class="btn " /></p>
...
<td class="textcenter"><input type="submit" value="{$LANG.upgradedowngradechooseproduct}" class="btn btn-default" /></form></td>
</tr>
{/foreach}
</table>
</div>
