    ...
    <div class="container">
        ...
        <div id="top-nav">
            ...
            {if $languagechangeenabled && count($locales) > 1}
                <div class="pull-right nav" id="whmp-languages_link_top">
            ...
            {if $loggedin}
                <div class="pull-right nav" id="whmp-notifications_link_top">
            ...
            {else}
                <div class="pull-right nav" id="whmp-login_link_top">
            ...
            {/if}
            <!-- Shopping Cart -->
            <div class="pull-right nav" id="whmp-cart_link_top">
        ...
        <a href="{$WEB_ROOT}/index.php" id="whmp-company_logo"><img src="{$WEB_ROOT}/templates/{$template}/img/logo.png" alt="{$companyname}" /></a>
