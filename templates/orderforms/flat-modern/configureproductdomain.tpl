...
{/foreach}
</select>&nbsp; <input type="submit" value="{$LANG.ordercontinuebutton}" class="btn btn-primary" />
</div>
</div>
{/if}
...
{/foreach}
</select>&nbsp; <input type="submit" value="{$LANG.checkavailability}" class="btn btn-primary" />
</div>
</div>
{/if}
...
www. <input type="text" id="owndomainsld" size="30" value="{$sld}" /> . <input type="text" id="owndomaintld" size="5" value="{$tld|substr:1}" />&nbsp; <input type="submit" value="{$LANG.ordercontinuebutton}" class="btn btn-primary" />
</div>
</div>
{/if}
{if $subdomains}
...
http:// <input type="text" id="subdomainsld" size="30" value="{$sld}" /> <select id="subdomaintld">{foreach from=$subdomains key=subid item=subdomain}<option value="{$subid}">{$subdomain}</option>{/foreach}</select>&nbsp; <input type="submit" value="{$LANG.ordercontinuebutton}" class="btn btn-primary" />
</div>
</div>
{/if}
</div>
