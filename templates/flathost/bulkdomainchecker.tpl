...
<div class="well">
    ...
    <div class="textcenter">
        ...
        {/if}
        <div class="internalpadding"><input type="submit" value="{$LANG.checkavailability}" class="btn btn-primary btn-lg" /></div>
    </div>
</div>
...
{/foreach}</select> <input class="btn btn-default" type="submit" value="{$LANG.go}" /></p>
</form>
{/if}
