...
<div class="searchbox col-sm-3">
    <form method="post" action="clientarea.php?action=products">
      ...
      <input class="form-control" type="text" name="q" value="{if $q}{$q}{else}{$LANG.searchenterdomain}{/if}" class="input-medium appendedInputButton" onfocus="if(this.value=='{$LANG.searchenterdomain}')this.value=''" />
