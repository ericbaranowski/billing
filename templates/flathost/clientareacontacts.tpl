...
<form class="form" method="post" action="{$smarty.server.PHP_SELF}?action=contacts&id={$contactid}">
...
<div id="subaccountfields" class="well{if !$subaccount} collapse{/if}">
...
<fieldset>
    ...
    <div class="form-group">
        <label class="form-control" for="passstrength">{$LANG.pwstrength}</label>
        <div class="controls">
    ...
    <div class="form-group">
        ...
        <div class="controls">
            <ul class="inputs-list">
                ...
                <li>
                    <label class="form-control" class="full control-label">
