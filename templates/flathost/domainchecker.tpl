...
<div class="well">
    ...
    <br />
    <div class="textcenter"><input type="button" value="{$LANG.searchmultipletlds} &raquo;" class="btn btn-sm pull-right" onclick="jQuery('#tlds').slideToggle()" />
        <div class="form-group col-md-12">
        <input class="form-control input-lg" name="domain" type="text" value="{if $domain}{$domain}{else}{$LANG.domaincheckerdomainexample}{/if}" onfocus="if(this.value=='{$LANG.domaincheckerdomainexample}')this.value=''" onblur="if(this.value=='')this.value='{$LANG.domaincheckerdomainexample}'" /></div>
    </div>
    <div class="domcheckertldselect collapse" id="tlds">
    ...
    <div class="textcenter">
        ...
        {/if}
        <div class="internalpadding"><input type="submit" value="{$LANG.checkavailability}" class="btn btn-primary btn-lg" />{if $condlinks.domaintrans} <input type="submit" name="transfer" value="{$LANG.domainstransfer}" class="btn btn-success btn-lg" />{/if} <input type="submit" name="hosting" value="{$LANG.domaincheckerhostingonly}" class="btn btn-lg" /></div>
    </div>
</div>
