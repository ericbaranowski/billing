<div id="clientsummarycontainer">
	...
	<!-- Start Edit -->
    <span align="right" class="pull-right" style="position: relative; padding-bottom: 15px;">
	
	    <input type="button" value="{$_ADMINLANG.clientsummary.statusfilter}: {if $statusfilterenabled}{$_ADMINLANG.global.on}{else}{$_ADMINLANG.global.off}{/if}" class="btn btn-xs btn-small{if $statusfilterenabled} btn-success{/if}" onclick="toggleStatusFilter()" />
		<div id="statusfilter" style="margin: 0px; right: -2px; text-align: left;">
			<form>
				<div class="checkall">
