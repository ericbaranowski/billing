...
<li><a title="Help" href="">{$_ADMINLANG.help.title}</a>
  <ul>
    <li><a href="http://anonym.to/?http://docs.whmcs.com/" target="_blank">{$_ADMINLANG.help.docs}</a></li>
    ...
    <li><a href="http://anonym.to/?http://forum.whmcs.com/" target="_blank">{$_ADMINLANG.help.forums}</a></li>
  </ul>
</li>