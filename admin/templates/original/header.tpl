...
{if $helplink}<div class="contexthelp"><a href="http://anonym.to/?http://docs.whmcs.com/{$helplink}" target="_blank"><img src="images/icons/help.png" border="0" align="absmiddle" /> {$_ADMINLANG.help.contextlink}</a></div>{/if}
</div>
