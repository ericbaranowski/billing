...
<div class="smallfont sys-info">{$_ADMINLANG.license.regto}: {$licenseinfo.registeredname}<br />{$_ADMINLANG.license.type}: {$licenseinfo.productname}<br />{$_ADMINLANG.license.expires}: {$licenseinfo.expires}<br />{$_ADMINLANG.global.version}: {$licenseinfo.currentversion}{if $licenseinfo.currentversion neq $licenseinfo.latestversion}<br /><span class="textred"><b>{$_ADMINLANG.license.updateavailable}</b></span>{/if}</div>
...
<form method="get" action="search.php">
	<div>
    <select class="selectboxit" name="type" id="searchtype" onchange="populate(this)">
    ...
    <div>
    <select class="selectboxit" name="field" id="searchfield">
