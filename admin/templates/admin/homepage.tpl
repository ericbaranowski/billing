...
{if $viewincometotals}
<div id="incometotals" style="font-size:18px; text-align: center;">

<!-- <a href="transactions.php">{$_ADMINLANG.billing.income}</a> --> <img style="position: relative; top: 20px;" src="images/loading.gif" align="absmiddle" /> </div>
