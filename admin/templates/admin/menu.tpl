<!--<li class="navbar"><a class="navlink first" href="index.php" title="Home">{$_ADMINLANG.home.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink first" {if in_array("List Clients",$admin_perms)}href="clients.php"{/if} title="Clients"><span class="icon clients-icon"></span>{$_ADMINLANG.clients.title}</a>
  <ul>
    ...
    <li class="expand"><a href="clientshostinglist.php">{$_ADMINLANG.services.title}<span class="expand-arrow"></span></a>
        <ul>
...
<li class="navbar"><a class="navlink" {if in_array("View Orders",$admin_perms)}href="orders.php"{/if} title="Orders"><span class="icon orders-icon"></span>{$_ADMINLANG.orders.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink" {if in_array("List Transactions",$admin_perms)}href="transactions.php"{/if} title="Billing"><span class="icon billing-icon"></span>{$_ADMINLANG.billing.title}</a>
  <ul>
    ...
    <li class="expand"><a href="invoices.php">{$_ADMINLANG.invoices.title}<span class="expand-arrow"></span></a>
        <ul>
    ...
    {if in_array("View Billable Items",$admin_perms)}<li class="expand"><a href="billableitems.php">{$_ADMINLANG.billableitems.title}<span class="expand-arrow"></span></a>
        <ul>
    ...
    {if in_array("Manage Quotes",$admin_perms)}<li class="expand"><a href="quotes.php">{$_ADMINLANG.quotes.title}<span class="expand-arrow"></span></a>
        <ul>
...
<li class="navbar"><a class="navlink" {if in_array("Support Center Overview",$admin_perms)}href="supportcenter.php"{/if} title="Support"><span class="icon support-icon"></span>{$_ADMINLANG.support.title}</a>
  <ul>
    ...
    {if in_array("List Support Tickets",$admin_perms)}<li class="expand"><a href="supporttickets.php">{$_ADMINLANG.support.supporttickets}<span class="expand-arrow"></span></a>
        <ul>
    ...
    {if in_array("Manage Network Issues",$admin_perms)}<li class="expand"><a href="networkissues.php">{$_ADMINLANG.networkissues.title}<span class="expand-arrow"></span></a>
        <ul>
...
{if in_array("View Reports",$admin_perms)}<li class="navbar"><a class="navlink" title="Reports" href="reports.php"><span class="icon reports-icon"></span>{$_ADMINLANG.reports.title}</a>
  <ul>
...
<li class="navbar"><a class="navlink" title="Utilities" href=""><span class="icon utilities-icon"></span>{$_ADMINLANG.utilities.title}</a>
  <ul>
    ...
    {if in_array("Database Status",$admin_perms) || in_array("System Cleanup Operations",$admin_perms) || in_array("View PHP Info",$admin_perms)}<li class="expand"><a href="#">{$_ADMINLANG.utilities.system}<span class="expand-arrow"></span></a>
        <ul>
    ...
    {if in_array("View Activity Log",$admin_perms) || in_array("View Admin Log",$admin_perms) || in_array("View Module Debug Log",$admin_perms) || in_array("View Email Message Log",$admin_perms) || in_array("View Ticket Mail Import Log",$admin_perms) || in_array("View WHOIS Lookup Log",$admin_perms)}<li class="expand"><a href="#">{$_ADMINLANG.utilities.logs}<span class="expand-arrow"></span></a>
        <ul>
...
<li class="navbar"><a class="navlink" title="Addons" href="addonmodules.php"><span class="icon addons-icon"></span>{$_ADMINLANG.utilities.addonmodules}</a>
  <ul>
...
<li class="navbar"><a class="navlink" title="Setup" href=""><span class="icon setup-icon"></span>{$_ADMINLANG.setup.title}</a>
  <ul>
...
{if in_array("Configure Administrators",$admin_perms) || in_array("Configure Admin Roles",$admin_perms) || in_array("Configure Two-Factor Authentication",$admin_perms)}
    <li class="expand"><a href="#">{$_ADMINLANG.setup.staff}<span class="expand-arrow"></span></a>
        <ul>
...
{if in_array("Configure Currencies",$admin_perms) || in_array("Configure Payment Gateways",$admin_perms) || in_array("Configure Tax Setup",$admin_perms) || in_array("View Promotions",$admin_perms)}
    <li class="expand"><a href="#">{$_ADMINLANG.setup.payments}<span class="expand-arrow"></span></a>
        <ul>
...
{if in_array("View Products/Services",$admin_perms) || in_array("Configure Product Addons",$admin_perms) || in_array("Configure Product Bundles",$admin_perms) || in_array("Configure Domain Pricing",$admin_perms) || in_array("Configure Domain Registrars",$admin_perms) || in_array("Configure Servers",$admin_perms)}
    <li class="expand"><a href="#">{$_ADMINLANG.setup.products}<span class="expand-arrow"></span></a>
        <ul>
...
{if in_array("Configure Support Departments",$admin_perms) || in_array("Configure Ticket Statuses",$admin_perms) || in_array("Configure Support Departments",$admin_perms) || in_array("Configure Spam Control",$admin_perms)}
    <li class="expand"><a href="#">{$_ADMINLANG.support.title}<span class="expand-arrow"></span></a>
        <ul>
...
{if in_array("Configure Order Statuses",$admin_perms) || in_array("Configure Security Questions",$admin_perms) || in_array("View Banned IPs",$admin_perms) || in_array("Configure Banned Emails",$admin_perms) || in_array("Configure Database Backups",$admin_perms)}
    <li class="expand"><a href="#">{$_ADMINLANG.setup.other}<span class="expand-arrow"></span></a>
        <ul>
...
<li class="navbar"><a class="navlink" title="Help" href=""><span class="icon help-icon"></span>{$_ADMINLANG.help.title}</a>
  <ul>
