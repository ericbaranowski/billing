...
$_LANG['cartbrowse'] = "یافتن محصولها و سرویس ها";
...
$_LANG['cartproductdomainuseincart'] = "از دامنه که همینک در کارت خرید است استفاده شود";
...
$_LANG['clientareacancelinvalid'] = "خطا! حسابی که میخواهید لغو کنید ممکن است همینک برای لغو شدن معلق باشد و یا این آیتم یافت نشده باشد.";
...
$_LANG['domainnameservers'] = "NameServer's";
...
$_LANG['invoicestransdate'] = "تاریخ صورت حساب";
...
$_LANG['registerdisablednotice'] = "لطفا یک سفارشبرای ثبت ارسال کنید.";
...
$_LANG['domaincheckerbulkinvaliddomain'] = "یک یا چند مورد از دامنه های وارد شده معتبر نمیباشند و از نتایج حذف شدند.";
...
$_LANG['twofabackupcodereset'] = "ورود از طریق کد پشتیبان گیری موفقیت آمیز بود. کدهای پشتیبان فقط یک بار معتبر هستند. این کد همینک ریست خواهد شد.";
...
$_LANG['announcementsbymonth'] = "به وسیله ماه";
...
$_LANG['tableentersearchterm'] = "عبارت جستجو را وارد کنید ...";
...
$_LANG['getsupport'] = "دریافت پشتیبانی";

$_LANG['news'] = "اخبار";
$_LANG['allthelatest'] = "همه از آخرین";
...
$_LANG['clientHomePanels']['activeProductsServicesNone'] = "انگار هیچ سرویس و محصولی نزد ما ندارید. برای شروع همینک یک سفارش ارسال کنید";
...
$_LANG['doToday'] = "اروز مایل هستید چه کاری انجام دهید؟";
...
$_LANG['domaincheckerunabletooffertld'] = "متاسفانه همینک قادر به ثبت این پسوند نمیباشیم.";
...
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "همینک پرداخت کنید";
...
$_LANG['licensingaddon']['downloadnow'] = "همینک دانلود کنید";
...
$_LANG['cPanel']['usageUpgradeNow'] = "همینک ارتقا دهید";
...
$_LANG['cPanel']['packageNotActive'] = "بسته ی میزبانی وب همینک";
