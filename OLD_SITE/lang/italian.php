...
$_LANG['addfundsmaximumbalanceerror'] = "L'importo massimo del saldo &egrave;:";
$_LANG['addfundsmaximumerror'] = "L'importo massimo del deposito &egrave;:";
$_LANG['addfundsminimum'] = "Deposito Minimo";
$_LANG['addfundsminimumerror'] = "Il Deposito Minimo &egrave;";
...
$_LANG['affiliatesfootertext'] = "Quando qualcuno arriver&agrave;;sul nostro sito attraverso il tuo link di affiliato, verr&agrave;; inserito un cookie contenente il tuo ID affiliato cos&igrave; anche se torneranno sul sito in un secondo momento riceverai comunque la tua provvigione..";
...
$_LANG['affiliateswithdrawalrequestsuccessful'] = "La tua richiesta di pagamento &egrave; stata inviata. Sarai contattato a breve.";
...
$_LANG['cartexistingclientlogindesc'] = "Per aggiungere quest'ordine al tuo account &egrave; necessario effettuare il login qui sotto.";
...
$_LANG['cartproductdomaindesc'] = "Il prodotto/servizio scelto &egrave; collegato ad un dominio. Ti preghiamo di inserirlo qui sotto";
...
$_LANG['clientareaaddfundsdisabled'] = "Al momento non &egrave; consentito aggiungere fondi in anticipo.";
$_LANG['clientareaaddfundsnotallowed'] = "Devi avere almeno un ordine attivo per poter aggiungere fondi. Al momento non &egrave; possibile procedere.";
$_LANG['clientareaaddon'] = "Opzioni extra";
$_LANG['clientareaaddonorderconfirmation'] = "Grazie! Il tuo ordine per l'opzione aggiuntiva mostrata sotto &egrave; stata inserita. Ti preghiamo di scegliere tra le seguenti opzioni la tua modalit&agrave; di pagamento.";
...
$_LANG['clientareacancelconfirmation'] = "Grazie. La tua richiesta di disdetta &egrave; stata inviata. Se hai effettuato questa operazione per errore, apri immediatamente un ticket o il tuo account verr&agrave;cancellato.";
$_LANG['clientareacancelinvalid'] = "Questo account ha gi&agrave; ricevuto una richiesta di disdetta e pertanto non &egrave; possibile inviarne ancora.";
...
$_LANG['clientareaerroraddress12'] = "Il tuo indirizzo pu&ograve;contenere solo lettere, numeri e spazi";
...
$_LANG['clientareaerrorcity2'] = "La tua Citt&agrave;pu&ograve;contenere solo lettere e spazi";
...
$_LANG['clientareaerrorfirstname2'] = "Il tuo nome pu&ograve;contenere solo lettere";
$_LANG['clientareaerrorisrequired'] = "campo richiesto";
$_LANG['clientareaerrorlastname'] = "Non hai inserito il cognome";
$_LANG['clientareaerrorlastname2'] = "Il tuo Cognome pu&ograve;contenere solo lettere";
$_LANG['clientareaerroroccured'] = "Si &egrave;verificato un errore, riprova pi&ugrave; tardi.";
...
$_LANG['clientareaerrorphonenumber2'] = "Il tuo numero di telefono non &egrave; valido";
$_LANG['clientareaerrorpostcode'] = "Non hai inserito il tuo CAP";
$_LANG['clientareaerrorpostcode2'] = "il tuo codice postale pu&ograve; contenere solo lettere, numeri e spazi";
...
$_LANG['clientareaheader'] = "Benvenuto nella tua Area Clienti! Da qui, sar&agrave; possibile gestire il tuo account. Questa pagina fornisce un breve riassunto del tuo account e mostra eventuali ticket di assistenza aperti o fatture inevase. Ti preghiamo cortesemente di tenere sempre aggiornate le tue informazioni di contatto.";
...
$_LANG['creditcard3dsecure'] = "A motivo delle misure antifrode, ti sar&agrave; ora richiesto di effettuare la verifica Verified by Visa o Mastercard SecureCode per completare il tuo pagamento.<br /><br /> Ti preghiamo di non aggiornare la pagina o tornare alla pagina precedente poich&eacute; altrimenti la transazione potrebbe essere interrotta o annullata.";
...
$_LANG['creditcardnumberinvalid'] = "Il numero della carta di credito inserito non &egrave; valido";
$_LANG['creditcardsecuritynotice'] = "Ogni dato della carta che inserisci qui &egrave; codificato per evitare i rischi di frode";
$_LANG['creditcarduseexisting'] = "Usa Carta di Credito esistente";
$_LANG['customfieldvalidationerror'] = "il valore non &egrave; valido";
$_LANG['days'] = "Giorni";
...
$_LANG['domaincheckerdescription'] = "Controlla la disponibilit&agrave; del dominio";
...
$_LANG['domainerror'] = "Si &egrave; verificato un problema nel collegamento al tuo registro di domini. Riprova pi&ugrave; tardi.";
...
$_LANG['domaingeteppcodeemailconfirmation'] = "Il codice EPP &egrave; stato inoltrato all'indirizzo email del registrante del tuo dominio.";
$_LANG['domaingeteppcodeexplanation'] = "Il codice EPP &egrave; una password per il dominio. Si tratta di una sicurezza che permette solo al registrante il trasferimento del dominio. Ne avrai bisogno se desideri trasferire il tuo dominio ad un altro registrar.";
$_LANG['domaingeteppcodefailure'] = "Errore nella richiesta del codice EPP:";
$_LANG['domaingeteppcodeis'] = "Il codice EPP per il tuo dominio &egrave;:";
$_LANG['domainidprotection'] = "ID Protection";
$_LANG['domainintrotext'] = "Specifica il nome del dominio e l'estensione (.it, .com, ecc.) che vuoi utilizzare qui sotto e clicca su Verifica per controllare se il dominio &egrave; disponibile all'acquisto.";
...
$_LANG['domainregisternsdelsuccess'] = "Il nameserver &egrave; stato cancellato correttamente";
...
$_LANG['domainregisternsmodsuccess'] = "Il nameserver &egrave; stato modificato correttamente";
...
$_LANG['domainregisternsregsuccess'] = "Il nameserver &egrave; stato inserito correttamente";
...
$_LANG['domainsautorenewdisabledwarning'] = "ATTENZIONE! Questo dominio non si rinnover&agrave; automaticamente.<br />Se non verr&agrave; rinnovato manualmente, alla sua scadenza verr&agrave; disattivato.";
...
$_LANG['downloadspopular'] = "I download pi&ugrave; scaricati";
...
$_LANG['imagecheck'] = "Tti preghiamo di inserire il codice di sicurezza mostrato nell'immagine - questa operazione &egrave; richiesta per prevenire invii automatizzati";
$_LANG['invoiceaddcreditamount'] = "Inserisci importo";
$_LANG['invoiceaddcreditapply'] = "Applica Credito";
$_LANG['invoiceaddcreditdesc1'] = "Il tuo credito &egrave;:";
$_LANG['invoiceaddcreditdesc2'] = "Puoi applicarlo alla tua fattura utilizzando il modulo qui sotto.";
$_LANG['invoiceaddcreditoverbalance'] = "Non puoi applicare pi&ugrave; credito di quanto dovuto";
$_LANG['invoiceaddcreditovercredit'] = "Non puoi applicare pi&ugrave; credito di quanto &egrave; disponibile nel tuo account";
$_LANG['invoicenumber'] = "Fattura #";
$_LANG['invoiceofflinepaid'] = "I pagamenti con carta di credito offline sono elaborati manualmente.<br />Riceverai una conferma di pagamento non appena il pagamento sar&agrave; stato  elaborato.";
...
$_LANG['invoicesbacktoclientarea'] = "&laquo; Torna ad Area Clienti";
...
$_LANG['invoiceserror'] = "Si &egrave; verificato un errore. Riprova.";
...
$_LANG['knowledgebasedescription'] = "Sfoglia l'Archivio Domande per le risposte alle domande pi&ugrave; frequenti";
$_LANG['knowledgebasefavorites'] = "Aggiungi ai Preferiti";
$_LANG['knowledgebasehelpful'] = "Hai trovato questa risposta utile?";
$_LANG['knowledgebaseintrotext'] = "L'Archivio Domande &egrave; organizzato in categorie. Puoi consultare una categoria o cercare una risposta al tuo quesito.";
...
$_LANG['knowledgebasepopular'] = "Gli articoli pi&ugrave; popolari";
...
$_LANG['knowledgebaseyes'] = "S&igrave;";
...
$_LANG['maxmind_callingnow'] = "Stiamo disponendo una chiamata automatizzata al tuo numero di telefono. Ci&ograve; fa parte della nostre misure antifrode. Ti verr&agrave; dato un codice di sicurezza di 4 cifre che dovrai inserire sotto per completare l'ordine.";
...
$_LANG['maxmind_faileddescription'] = "Il codice inserito non &egrave;corretto. Se ritieni sia un errore contatta al pi&ugrave; presto la nostra assistenza.";
...
$_LANG['maxmind_highriskcountry'] = "Purtroppo non siamo in grado di accettare il tuo ordine poich&eacute; proviene da una nazione dove &egrave; stata registrata molta attivit&agrave; fraudolenta. Se desideri utilizzare un metodo di pagamento alternativo, ti preghiamo di contattarci.";
...
$_LANG['ordercodenotfound'] = "Il codice della promozione inserito non &egrave;valido";
$_LANG['ordercompletebutnotpaid'] = "Attenzione! il tuo ordine &egrave; stato completato ma non ancora saldato e non verr&agrave; attivato.<br />Clicca sul link di seguito per saldare la tua fattura.";
...
$_LANG['orderdomainoption2'] = "aggiorner&ograve; i nameserver di un dominio esistente oppure registrer&ograve; un nuovo dominio.";
...
$_LANG['ordererroruserexists'] = "Un utente &egrave; gi&agrave; registrato con lo stesso indirizzo email";
...
$_LANG['orderinvalidcodeforbillingcycle'] = "Questo codice non pu&ograve; essere applicato al ciclo di fatturazione selezionato";
...
$_LANG['orderpromoinvalid'] = "Il codice della promozione inserito non &egrave; compatibile con nessun articolo del tuo ordine";
...
$_LANG['ordersecure2'] = "&egrave; stato memorizzato.";
...
$_LANG['ordertransferdomain'] = "Trasferisci un dominio gi&agrave; esistente";
...
$_LANG['promoonceperclient'] = "Questo codice pu&ograve;essere utilizzato solo una volta per cliente";
...
$_LANG['registerdomaindesc'] = "Inserisci il dominio per verificarne la disponibilit&agrave;.";
...
$_LANG['securitycurrentincorrect'] = "La tua domanda e risposta attuale &egrave; errata ";
...
$_LANG['sslconfigcompletedetails'] = "La configurazione del certificato SSL &egrave; stata completata e trasmessa all' Authority per la convalida. Dovresti ricevere una loro e-mail a breve per approvarla.";
...
$_LANG['supportticketinvalid'] = "Errore. Il ticket richiesto non &egrave;stato trovato.";
...
$_LANG['supportticketssystemdescription'] = "Il ticket di assistenza ci permette di risolvere i problemi il pi&ugrave; velocemente possibile. Quando forniamo una risposta al tuo ticket, sarai avvisato via email.";
$_LANG['supportticketsticketattachments'] = "Allegati";
$_LANG['supportticketsticketcreated'] = "Ticket aperto";
$_LANG['supportticketsticketcreateddesc'] = "Il tuo ticket &egrave; stato aperto correttamente. Una mail &egrave; stata inviata al tuo indirizzo con le informazioni riepilogative. Puoi anche visualizzare questo ticket ora se vuoi.";
...
$_LANG['supportticketsticketurgency'] = "Priorit&agrave;";
...
$_LANG['telesigninitiatephone'] = " Non ci &egrave; possibile verificare automaticamente via telefono. Ti preghiamo di contattarci.";
...
$_LANG['telesignsmstextmessage'] = "Grazie per aver utilizzato il nostro sistema di verifica via SMS. Il tuo codice &egrave;: %s Ti preghiamo di inserirlo ora sul tuo computer.";
$_LANG['telesigntitle'] = "TeleSign verifica telefonica.";
$_LANG['telesigntype'] = "Scegli il tipo di verifica per il numero %s:";
$_LANG['telesignverificationcanceled'] = "Ci sono problemi temporanei con il servizio di verifica telefonica e la richiesta di verifica &egrave; stata annullata.";
$_LANG['telesignverificationproblem'] = "Si &egrave; verificato un problema con il servizio di verifica telefonica ed il vostro ordine non &egrave; stato convalidato. Riprova pi&ugrave; tardi.";
...
$_LANG['transferdomaindesc'] = "Vuoi trasferire il tuo dominio presso di noi? Se s&igrave;, scrivi qui sotto il tuo dominio per iniziare.";
...
$_LANG['upgradeproductlogic'] = "Il prezzo di aggiornamento &egrave; calcolato da un accredito della parte inutilizzata del pacchetto attuale e della fatturazione del nuovo pacchetto per lo stesso periodo.";
...
$_LANG['varilogixfraudcall_description'] = "Come misura antifrode verr&agrave; ora verificato il numero telefonico e richiesto l'inserimento del codice PIN. Prendi nota del codice e quando sei pronto per ricevere la chiamata, clicca sul tasto qui sotto.";
$_LANG['varilogixfraudcall_error'] = "Si &egrave; verificato un errore e non possiamo contattare il tuo numero telefonico per confermare l'ordine. Ti preghiamo di contattare al pi&ugrave; presto il nostro supporto.";
$_LANG['varilogixfraudcall_fail'] = "Non &egrave; stato possibile effettuare la chiamata di verifica dell'ordine. Probabilmente il numero telefonico inserito &egrave; errato oppure &egrave; inserito in una lista nera sui nostri sistemi. Ti preghiamo di contattare al pi&ugrave; presto la nostra assistenza per completare il tuo ordine.";
...
$_LANG['pwresetsecurityquestionrequired'] = "Poich&eacute; &egrave; stata trovata una domanda di sicurezza per il tuo account, devi inserire la risposta alla domanda qui sotto.";
...
$_LANG['pwresetkeyinvalid'] = "Il link per il reset della password non &egrave; valido. Riprova.";
$_LANG['pwresetkeyexpired'] = "Il link per il reset della password &egrave; scaduto. Riprova.";
...
$_LANG['invoicepaymentfailedconfirmation'] = "Il pagamento non &egrave; andato a buon fine.<br />Riprova in seguito o contatta la nostra assistenza.";

# Version 4.2

$_LANG['promoappliedbutnodiscount'] = "Il codice promozionale che hai inserito &egrave; stato applicato al tuo carrello, ma nessun articolo pu&ograve; beneficiare di tale sconto - Consulta i termini della promozione ";

$_LANG['upgradeerroroverdueinvoice'] = "Al momento non &egrave; possibile effettuare un upgrade o downgrade di questo prodotto perch&egrave; la fattura &egrave; gi&agrave; stata generata per il prossimo rinnovo.<br /> <br />Per procedere, occorre prima saldare la fattura in sospeso e poi potrai fare un upgrade o downgrade. Ti sar&agrave; addebitata o accreditata la differenza a seconda dei casi.";
...
$_LANG['ordersummarybegin'] = "Il carrello &egrave; vuoto<br/>Scegli un prodotto per iniziare...";
...
$_LANG['cartexistingcustomer'] = "Sono gi&agrave; cliente";
...
$_LANG['cartdomainavailableoptions'] = "Congratulazioni! questo dominio &egrave; disponibile!";
$_LANG['cartdomainavailableregister'] = "Registra questo dominio per";
$_LANG['cartdomainavailablemanual'] = "Lo registrer&ograve; separatamente";

$_LANG['cartdomainunavailableoptions'] = "Spiacente, questo dominio &egrave; stato gi&agrave; registrato. Se ne sei il proprietario, scegli una delle opzioni qui sotto...";
$_LANG['cartdomainunavailabletransfer'] = "Vi prego di trasferire il mio dominio per";
$_LANG['cartdomainunavailablemanual'] = "Posseggo gi&agrave; questo dominio e aggiorner&ograve; i nameserver";

$_LANG['cartdomaininvalid'] = "Il dominio che hai inserito non &egrave; valido. Inserisci solo la parte dopo www.e includi l' estensione";
...
$_LANG['domaindnspriority'] = "Priorit&agrave;";
$_LANG['domaindnsmxonly'] = "Record priorit&agrave; solo per MX";

$_LANG['orderpromoprestart'] = "Questa promozione non &egrave; ancora attiva. Riprova in un altro momento.";
...
$_LANG['invoicepaymentpendingreview'] = "Grazie! Il tuo pagamento &egrave; andato a buon fine e sar&agrave; applicato al tuo account al termine dei controlli di legge da parte di 2CheckOut.<br /><br />Ti preghiamo di notare che il processo di verifica potrebbe impiegare qualche ora. Apprezziamo grandemente la tua pazienza al riguardo.";

$_LANG['step'] = "Passo %s";
$_LANG['cartdomainexists'] = "Questo dominio esiste gi&agrave; nel nostro database. Non &egrave; possibile ordinarlo di nuovo.";
$_LANG['cartcongratsdomainavailable'] = "Congratulazioni, %s &egrave; disponibile!";
$_LANG['cartregisterhowlong'] = "Per quanti anni vuoi registrare questo dominio?";
$_LANG['cartdomaintaken'] = "Spiacente, %s non &egrave; disponibile";
...
$_LANG['cartexistingdomainchoice'] = "Utilizzer&ograve; il mio dominio esistente ed aggiorner&ograve; i nameserver";
...
$_LANG['recurringpromodesc'] = "Questo codice promozionale include uno sconto ricorrente di %s<br />(Questo sconto verr&agrave;applicato al prezzo totale dei rinnovi futuri)";
...
$_LANG['thereisaproblem'] = "Oops, si &egrave; verificato un problema...";
$_LANG['problemgoback'] = "Torna indietro e riprova";

$_LANG['quantity'] = "Quantit&agrave;";
$_LANG['cartqtyenterquantity'] = "Te ne occorre pi&ugrave; di uno? Inserisci qui la quantit&agrave; richiesta:";
...
$_LANG['domainrenewalsbeforerenewlimit'] = "Il periodo minimo di rinnovo anticipato &egrave; di %s giorni";
...
$_LANG['domainbulkmanagementchangeaffect'] = "La modifica si applicher&agrave;ai seguenti domini:";
$_LANG['domaincannotbemanaged'] = "non &egrave; possibile gestire questo dominio automaticamente. Ti preghiamo di contattare l'Assistenza per richiedere le modifiche";
$_LANG['domainbulkmanagementnotpossible'] = "Al momento non &egrave; possibile effettuare queste modifiche dall'Area Clienti, ti preghiamo di contattare l'Assistenza per richiederle.";
...
$_LANG['bundlevaliddateserrordesc'] = "Questa offerta non &egrave; attiva oppure non &egrave; pi&ugrave; disponibile. Se credi si tratti di un errore, contatta l'Assistenza Tecnica.";
$_LANG['bundlemaxusesreached'] = "Offerta non disponibile";
$_LANG['bundlemaxusesreacheddesc'] = "Questa offerta ha raggiunto il numero massimo di utenti e purtroppo non &egrave; pi&ugrave; disponibile. Ti preghiamo di contattarci se sei interessato ad acquistare i nostri servizi.";
$_LANG['bundlereqsnotmet'] = "Non sono stati soddisfatti i requisiti per questa offerta";
$_LANG['bundlewarningpromo'] = "La presente offerta non &egrave;cumulabile con altre offerte o promozioni in corso";
...
$_LANG['bundlewarningproductconfopqtyreq'] = "Per beneficiare dell'offerta selezionata devi indicare una quantit&agrave; '%s' per il prodotto '%s'";
...
$_LANG['clientareahomelogin'] = "Sei gi&agrave; registrato? Clicca sul tasto qui sotto per accedere alla tua Area Clienti e gestire il tuo account.";
...
$_LANG['domaincheckerintro'] = "Controlla se il dominio che intendi registrare &egrave; disponibile.";
...
$_LANG['ccexpiringsoondesc'] = "La tua carta di credito sta per scadere a breve, ti preghiamo di aggiornare i dati al pi&ugrave; presto.";
$_LANG['availcreditbal'] = "Credito Disponibile";
$_LANG['availcreditbaldesc'] = "Hai un credito di %s disponibile. Questo credito sar&agrave; applicato alle prossime fatture.";
$_LANG['youhaveoverdueinvoices'] = "Hai %s Fattura/e non pagata/e";
$_LANG['overdueinvoicesdesc'] = "Al fine di evitare la sospensione del servizio, ti invitiamo ad effettuare il saldo al pi&ugrave; presto. %sPaga ora cliccando qui &raquo;%s";
...
$_LANG['serverstatusheadingtext'] = "La tabella sottostante indica lo stato dei nostri server in tempo reale. Da qui puoi vedere se risulta qualche problema gi&agrave; segnalato in lavorazione.";
...
$_LANG['domaincheckerchecknewdomain'] = "Controlla la disponibilit&agrave; di un dominio";
$_LANG['domaincheckerdomainexample'] = " es. miodominio.it";
$_LANG['domaincheckerinvalidtld'] = "non &egrave; una estensione valida. Riprova.";
$_LANG['domaincheckerhostingonly'] = "Ordina solamente l'hosting";
$_LANG['domaincheckeravailtransfer'] = "Disponibile per il trasferimento";
...
$_LANG['domaincheckerbulkinvaliddomain'] = "Uno o pi&ugrave; domini inseriti non &egrave; corretto ed &egrave; stato omesso dai risultati.";
...
$_LANG['supportticketspriority'] = "Priorit&agrave;";
...
$_LANG['affiliatesignupinfo3'] = "Se vuoi saperne di pi&ugrave;, contattaci.";
...
$_LANG['domainaddonsdnsmanagementinfo'] = "L'hosting DNS esterno pu&ograve; aiutare a velocizzare il tuo sito web e migliorare la raggiungibilit&agrave; riducendo i tempi di ridondanza.";
...
$_LANG['alreadyunsubscribed'] = "Ti sei gi&agrave; cancellato dalla newsletter.";
...
$_LANG['unsubscribehashinvalid'] = "Non &egrave; stato possibile cancellarti, contatta l'Assistenza Tecnica.";
...
$_LANG['erroroccured'] = "si &egrave; verificato un errore";
$_LANG['pwresetsuccessdesc'] = "la tua password &egrave; stata re-impostata. %s clicca qui%s per accedere all'Area Clienti...";
$_LANG['pwresetenternewpw'] = "Inserisci la tua nuova password qui sotto.";
$_LANG['ordererrorsbudomainbanned'] = "Questo prefisso di sottodominio non &egrave; valido - ti preghiamo di riprovare";

$_LANG['ticketfeedbacktitle'] = "La tua opinione sul ticket";

$_LANG['nosupportdepartments'] = "Il reparto assistenza non &egrave; ora disponibile. Ti preghiamo di riprovare pi&ugrave; tardi.";

$_LANG['feedbackclosed'] = "Non puoi inviarci la tua opinione fino a quando il ticket non &egrave; stato chiuso.";
$_LANG['feedbackprovided'] = "Hai gi&agrave; fornito la tua opinione per questo ticket.";
...
$_LANG['twofaenforced'] = "Per la tua sicurezza, ti chiediamo di attivare l' Autenticazione a doppio livello prima di continuare. Questa pagina ti guider&agrave; nel suo  processo di attivazione.";
$_LANG['twofasetup'] = "Imposta l'autenticazione a doppio livello";
$_LANG['twofasetupgetstarted'] = "Inizia";
$_LANG['twofaactivationintro'] = "Autenticazione a doppio livello aggiunge un ulteriore livello di sicurezza all'accesso. Una volta impostata e configurata, ogni volta che effettuerai l'accesso ti verr&agrave; richiesto l'username, la password, pi&ugrave; un secondo livello di sicurezza come ad esempio un PIN.";
...
$_LANG['twofaactivationerror'] = "Si &egrave; verificato un errore cercando di attivare l'Autenticazione a doppio livello per il tuo account. Ti preghiamo di riprovare.";
$_LANG['twofamoduleerror'] = "Si &egrave; verificato un errore nel caricamento del modulo. Ti preghiamo di riprovare.";
...
$_LANG['twofabackupcodeis'] = "Il tuo codice di riserva &egrave;";
$_LANG['twofanewbackupcodeis'] = "Il tuo nuovo codice di riserva &egrave;";
...
$_LANG['twofa2ndfactorincorrect'] = "Il secondo fattore di autenticazione che hai immesso non &egrave; corretto. Ti preghiamo di riprovare.";
$_LANG['twofabackupcodereset'] = "Accesso tramite codice di riserva riuscito. Il codice di riserva &egrave; valido una sola volta e sar&agrave; quindi reimpostato.";
...
$_LANG['twofageneralerror'] = "Si &egrave; verificato un errore caricando il modulo. Ti preghiamo di riprovare.";
