...
$_LANG['clientareanocontacts'] = "لم يتم العثور على مستخدم";
$_LANG['clientareapassword'] = "كلمة المرور";
$_LANG['clientareapending'] = "غير مفعّل";
...
$_LANG['domainregistrarlockdesc'] = "تفعيل تأمين المسجل (ينصح به). لكي لا يتم السماح بأي عمليات نقل إذا كان النطاق مقفلا للأمان.";
...
$_LANG['domainsautorenewenable'] = "تفعيل التجديد التلقائي";
$_LANG['domainsautorenewenabled'] = "تفعيل";
...
$_LANG['ordercompletebutnotpaid'] = "تنبيه! قد تم تنفيذ الطلب الخاص بك ولكنك لم تقم بدفع حتى الآن، لذلك لن يتم التفعيل <br/> .اضغط على الرابط أدناه لذهاب إلى الفاتورة الخاصة بك ودفعة";
...
$_LANG['supportticketclosedmsg'] = "هذه التذكرة مغلقة.  بإمكانك الرد على هذه التذكرة لإعادة فتحها.";
...
$_LANG['googleRecaptchaIncorrect'] = "يرجى إكمال رمز التحقق والمحاولة مرة أخرى.";
...
$_LANG['navservicesplaceorder'] = "إضافة طلب جديد";
...
$_LANG['navdomainsearch'] = "البحث عن نطاق";
...
$_LANG['registerCreateAccount'] = "لإنشاء حساب, يرجى";
$_LANG['registerCreateAccountOrder'] = "تقدم بطلبك معنا";
...
$_LANG['serverhostnameexample'] = "مثلا. server1(.yourdomain.com)";
$_LANG['serverns1prefixexample'] = "مثلا. ns1(.yourdomain.com)";
$_LANG['serverns2prefixexample'] = "مثلا. ns2(.yourdomain.com)";
...
$_LANG['maxmind_checkconfiguration'] = "حدث خطأ أثناء عملية كشف الاحتيال. يرجى مراسلة الدعم الفني.";
$_LANG['maxmind_addressinvalid'] = "لم يتم التعرف على عنوانك. يرجى التحقق منه واعادة ادخاله.";
$_LANG['maxmind_invalidip'] = "عنوان الأي بي خاطئ أو محلي. يرجى مراسلة الدعم الفني.";

$_LANG['ssounabletologin'] = "غير قادر على الدخول تلقائياً. يرجى مراسلة الدعم الفني.";
$_LANG['ssofatalerror'] = "حدث خطأ فادح. يرجى مراسلة الدعم الفني.";

# Version 6.0

$_LANG['announcementschoosemonth'] = "اختر شهر";
$_LANG['announcementsbymonth'] = "بالشهر";
$_LANG['announcementsolder'] = "إعلانات قديمة";
$_LANG['createnewcontact'] = "مستخدم جديد ...";
$_LANG['due'] = "مستحق";
$_LANG['affiliatessignups'] = "عدد مرات تسجيل الدخول";
$_LANG['affiliatesconversionrate'] = "تحويل العملة";
$_LANG['affiliatesclicks'] = "نقرة";
$_LANG['contacts'] = "جهات الاتصال";
$_LANG['backtoservicedetails'] = "العودة لتفاصيل الخدمة";
$_LANG['invoicesintro'] = "أدناه يمكنك مراجعة سجل الفواتير بأكمله.";

$_LANG['sidebars']['viewAccount']['yourAccount'] = "حسابك";
$_LANG['sidebars']['viewAccount']['myDetails'] = "تفاصيلي";
$_LANG['sidebars']['viewAccount']['billingInformation'] = "معلومات الدفع";
$_LANG['sidebars']['viewAccount']['contacts/subAccounts'] = "جهات اتصال/حسابات فرعية";
$_LANG['sidebars']['viewAccount']['changePassword'] = "تغيير كلمة المرور";
$_LANG['sidebars']['viewAccount']['securitySettings'] = "إعدادات الحماية";
$_LANG['sidebars']['viewAccount']['emailHistory'] = "سجل رسائل البريد";

$_LANG['aboutsecurityquestions'] = "لما أسئلة الحماية؟";
$_LANG['registersecurityquestionblurb'] = "وضع سؤال أمان يزيد من مسوى الحماية, حيث أن أي تعديل يتم على حسابك سيتطلب الإجابة على هذه الأسئلة.";

$_LANG['update'] = "تحديث";
$_LANG['yourinfo'] = "معلوماتك";
$_LANG['shortcuts'] = "اختصارات";

$_LANG['yourservices'] = "خدماتك";
$_LANG['yourdomains'] = "نطاقاتك";
$_LANG['yourtickets'] = "تذاكرك";
$_LANG['managecontacts'] = "إدارة المستخدمين";
$_LANG['billingdetails'] = "تفاصيل الدفع";
$_LANG['homechooseproductservice'] = "اختر خدمة/منتج لإدارته:";

$_LANG['invoicesdue'] = "الفواتير المستحقة";
$_LANG['invoicesduemsg'] = "لديك حالياً %s فاتورة غير مدفوعه بمبلغ إجمالي %s";
$_LANG['noinvoicesduemsg'] = "ليس لديك أي فاتورة غير مدفوعة.";

$_LANG['expiringsoon'] = "ينتهي قريباً";

$_LANG['notice'] = "ملاحظة";
$_LANG['networkstatussubtitle'] = "أخبار وبيانات";
...
$_LANG['whoisinfo'] = "بيانات WHOIS";

$_LANG['tableshowing'] = "عرض _START_ إلى _END_ من _TOTAL_ المدخلات";
$_LANG['tableempty'] = "يتم عرض 0 إلى 0 من 0 المدخلات";
$_LANG['tablefiltered'] = "(تصفية من _MAX_ إجمال المدخلات)";
$_LANG['tablelength'] = "عرض _MENU_ المدخلات";
$_LANG['tableloading'] = "جاري التحميل...";
$_LANG['tableprocessing'] = "جاري المعالجة...";
$_LANG['tablepagesfirst'] = "البداية";
$_LANG['tablepageslast'] = "النهاية";
$_LANG['tablepagesnext'] = "التالي";
$_LANG['tablepagesprevious'] = "السابق";
$_LANG['tableviewall'] = "الكل";
$_LANG['tableentersearchterm'] = "ادخل شروط البحث...";

$_LANG['actions'] = "عمليات";

$_LANG['upgradedowngradeshort'] = "ترقية/تراجع";

$_LANG['masspayintro'] = "ادفع كل الفواتير المدرجة أدناه في تحويله واحد سهلة عن طريق تحديد وسيلة دفع";
$_LANG['masspaymentselectgateway'] = "اختر طريقة الدفع الموحدة";

$_LANG['ticketfeedbackrequest'] = "رأيك مطلوب";
$_LANG['ticketfeedbackforticket'] = "في التذكرة #";

$_LANG['notifications'] = "تنبيهات";
$_LANG['notificationsnone'] = "ليس لديك أي تنبيهات في الوقت الحالي.";

$_LANG['creditcardnonestored'] = "لا يوجد بطاقة في الملف";

$_LANG['kbviewingarticlestagged'] = "عرض المقالات الموسومه";

$_LANG['domainprivatenameservers'] = "أسماء الخوادم الخاصة";

$_LANG['transferinadomain'] = "نقل نطاق";

$_LANG['nodomainextensions'] = "لا يوجد إمتدادات متاحة لحجزها الآن";

$_LANG['homebegin'] = "إبدأ بالبحث عن نطاقك المميز...";
$_LANG['howcanwehelp'] = "كيف نستطيع خدمتك اليوم؟";
$_LANG['exampledomain'] = "مثال. yourdomain.com";
$_LANG['buyadomain'] = "شراء نطاق";
$_LANG['orderhosting'] = "طلب إستضافة";
$_LANG['makepayment'] = "القيام بالدفع";
$_LANG['getsupport'] = "الحصول على الدعم الفني";

$_LANG['news'] = "أخبار";
$_LANG['allthelatest'] = "كل الأحدث من";
$_LANG['readmore'] = "إقرأ المزيد";
$_LANG['noannouncements'] = "لا يوجد إعلانات لعرضها";

$_LANG['kbsearchexplain'] = "لديك سؤال؟ إبدا بالبحث عنه هنا.";
$_LANG['readyforquestions'] = "نحن جاهزون وبإنتظار أسئلتك";

$_LANG['restrictedpage'] = "هذه الصفحة محظورة";
$_LANG['enteremail'] = "أدخل بريدك الإلكتروني";

$_LANG['passwordtips'] = "<strong>نصاحة لكملة مرور جيدة</strong><br />أستخدمة الحروف الكبيرة والصغيرة معاً<br />أضف على أقل رمز واحد (# $ ! % &amp; etc...)<br />لا تستخدم كلمات صحيحة";

$_LANG['regdate'] = "تاريخ التسجيل";
$_LANG['nextdue'] = "الإستحقاق التالي";

$_LANG['domaincheckertagline'] = "إبدأ بالبحث عن نطاقك المميز...";
$_LANG['findyourdomain'] = "احصل على نطاقك الجديد";
$_LANG['searchtermrequired'] = "يجب أن تدخل اسم النطاق للبحث عنه";
$_LANG['unabletolookup'] = "نأسف, لا يمكن البحث عن النطاق كما هو مسجل ";
$_LANG['invalidchars'] = "يرجى إزالة المسافات أو أي رموز";
$_LANG['bulkoptions'] = "الخيارات الجماعية";
$_LANG['checkingdomain'] = "يتم التحقق من توفر النطاق...";
$_LANG['domainsgotocheckout'] = "الذهاب للدفع";
$_LANG['domainssearchresults'] = "نتائج البحث";
$_LANG['domainssuggestions'] = "اقتراحات";
$_LANG['domainsothersuggestions'] = "قد تكون مهتما بهذه الأسماء البديلة أيضا";
$_LANG['domainsmoresuggestions'] = "أعطني مزيد من الاقتراحات!";
$_LANG['domainssuggestionswarnings'] = "قد لا تكون اقتراحات اسماء النطاقات متوفرة دائماً. التحقق من التوفر موجود عن الإضافة للسلة.";
$_LANG['disclaimers'] = "عدم مسؤولية";
$_LANG['tldpricing'] = "أسعار الإمتدادات";
$_LANG['alltldpricing'] = "أسعار كل الإمتدادات";

$_LANG['quotesdesc'] = "عروض الأسعار التي قمنا بتقديمها لك";
$_LANG['quotesrejected'] = "مرفوضة";

$_LANG['ticketsyourhistory'] = "سجل تذاكر الدعم الفني";

$_LANG['clientareaemaildesc'] = "سجل رسائل البريد الإلكتروني الخاصة بك";

$_LANG['sslconfssl'] = "إعداد SSL";
$_LANG['sslnoconfigurationpossible'] = "الإعدادات قد تمت مسبقاً!  يرجى مراسلة الدعم الفني إن كنت تواجه أي مشكلة.";

$_LANG['adminloggedin'] = "أنت مسجل دخولك حاليا كمدير.";
$_LANG['returntoadminarea'] = "الخروج والعودة للوحة الإدارة";
$_LANG['adminmasqueradingasclient'] = "أنت تتنكر حالياً كعميل.";
$_LANG['logoutandreturntoadminarea'] = "الخروج والعودة للوحة الإدارة";

$_LANG['supportAndUpdatesExpired'] = "الدعم الفني والتحديثات منتهية.";
$_LANG['supportAndUpdatesExpiredLicense'] = "الدعم الفني والتحديثات لهذا الترخيص قد انتهت";
$_LANG['supportAndUpdatesRenewalRequired'] = "الدعم الفني والتحديثات بحاجة للتجديد للتمكن من تحميل هذا الملف.";
$_LANG['supportAndUpdatesClickHereToRenew'] = "اضغط هنا للتجديد";

$_LANG['pwresetemailneeded'] = "نسيت كلمة المرور؟ ادخل بريدك الإلكتروني أدناه للبدء بعملية الاستعادة.";

$_LANG['quotestageexpired'] = "منتهي";

$_LANG['ticketinfo'] = "بيانات التذكرة";
$_LANG['customfield'] = "الحقول المخصصة";

$_LANG['domainsActive'] = "مفعّل";
...
$_LANG['domainsExpiringInTheNext30Days'] = "ينتهي خلال الـ 30 يوم القادمة";
$_LANG['domainsExpiringInTheNext90Days'] = "ينتهي خلال الـ90 يوم القادمة";
$_LANG['domainsExpiringInTheNext180Days'] = "ينتهي خلال الـ 180 يوم القادمين";
$_LANG['domainsExpiringInMoreThan180Days'] = "ينتهي خلال أكثر من 180 يوماً";

$_LANG['kbtagcloud'] = "سحابة الكلمات الدلالية";

$_LANG['cancellationrequestedexplanation'] = "هنالك طلب إلغاء حالياً على هذا المنتج/الخدمة";
$_LANG['cancellationrequested'] = "تم طلب الإلغاء";

$_LANG['yourrecenttickets'] = "أحدث تذاكرك";

$_LANG['domains']['deTermsDescription1'] = "لحجز نطاق جديد, نقله أو تعديل بيانات المسجل يجب على المسجل المواقة على شروط واحكام امتداد .DE .";
$_LANG['domains']['deTermsDescription2'] = "(شاهد النص بالكامل لشروط وأحكام إمتداد .de : http://www.denic.de/en/bedingungen.html.)";
$_LANG['directDebitPageTitle'] = "الدفع بالايداع النقدي";
$_LANG['directDebitHeader'] = "الدفع بالايداع النقدي";
$_LANG['directDebitErrorNoBankName'] = "يجب عليك إدخال اسم البنك";
$_LANG['directDebitErrorAccountType'] = "يجب عليك اختيار نوع حسابك البنكي";
$_LANG['directDebitErrorNoABA'] = "يجب عليك إدخال رمز ABA البنكي";
$_LANG['directDebitErrorAccNumber'] = "يجب عليك إدخال رقم حسابك البنكي";
$_LANG['directDebitErrorConfirmAccNumber'] = "يجب عليك تأكيد رقم حسابك البنكي";
$_LANG['directDebitErrorAccNumberMismatch'] = "رقم حسابك البنكي والتاكيد لا يتطابقان";
$_LANG['directDebitThanks'] = "شكراً لإضافة تفاصيلك. سنقوم باتمام عملية الدفع خلال الأيام القليلة القادمة, وسنقوم بمراسلة في حال وجود أي مشكلة.";
$_LANG['directDebitPleaseSubmit'] = "يرجى وضع تفاصيل حسابك البنك للدفع بواسطة الايداع المباشر.";
$_LANG['directDebitBankName'] = "اسم البنك";
$_LANG['directDebitAccountType'] = "نوع الحساب البنكي";
$_LANG['directDebitABA'] = "رمز ABA البنكي";
$_LANG['directDebitAccNumber'] = "رقم الحساب البنكي";
$_LANG['directDebitConfirmAccNumber'] = "اعتماد رقم الحساب";
$_LANG['directDebitSubmit'] = "اعتماد";
$_LANG['directDebitChecking'] = "جاري الفحص";
$_LANG['directDebitSavings'] = "مدخرات";

$_LANG['outOfStockProductRemoved'] = "تم إزالة منتج منتهي الكمية من سلة الشراء تلقائياً";

$_LANG['subaccountpermsquotes'] = "عرض وقبول عروض الأسعار";

$_LANG['chooselanguage'] = "اختر اللغة";
...
$_LANG['quotelineitems'] = "عناصر عرض السعر";

$_LANG['quoteproposal'] = "اقتراح";
$_LANG['quoteacceptagreetos'] = "للموافقة على عرض العسر, يرجى تأكيد موافقة على الشروط والاحكام.";
$_LANG['quoteacceptcontractwarning'] = "يرجى العلم أنه بمجرد موافقتك على عرض السعر فانه بمثابة عقد موقع ولا يحق لك إلغائه بعد ذلك.";

// Client alerts
$_LANG['clientAlerts']['creditCardExpiring'] = "بطاقتك :creditCardType-:creditCardLastFourDigits تنتهي خلال :days يوم. يرجى تحديثها خلال أقرب وقت ممكن.";
$_LANG['clientAlerts']['domainsExpiringSoon'] = "لديك :numberOfDomains نطاق ينتهي خلال :days يوم. جددهم الآن لراحة بالك.";
$_LANG['clientAlerts']['invoicesUnpaid'] = "لديك :numberOfInvoices فاتورة غير مدفوعة بمبلغ إجمالي :balanceDue. ادفعهم مبكراً لراحة بالك.";
$_LANG['clientAlerts']['invoicesOverdue'] = "لديك :numberOfInvoices فاتورة مستحقة بمبلغ إجمالي :balanceDue. ادفعهم الآن لتجنب أي مشاكل بالخدمة.";
$_LANG['clientAlerts']['creditBalance'] = "لديك برصيد بقيمة :creditBalance.";

// Client homepage panels
$_LANG['clientHomePanels']['unpaidInvoices'] = "فواتير غير مدفوعة";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "لديك :numberOfInvoices فاتورة غير مدفوعة بمبلغ إجمالي :balanceDue. ادفعهم مبكراً لراحة بالك.";
$_LANG['clientHomePanels']['overdueInvoices'] = "فواتير مستحقة";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "لديك :numberOfInvoices فاتورة مستحقة بمبلغ إجمالي :balanceDue. ادفعهم الآن لتجنب أي مشاكل بالخدمة.";
$_LANG['clientHomePanels']['domainsExpiringSoon'] = "نطاقات تنتهي قريباً";
$_LANG['clientHomePanels']['domainsExpiringSoonMsg'] = "لديك :numberOfDomains نطاق ينتهي خلال :days يوم. جددهم الآن لراحة بالك.";
$_LANG['clientHomePanels']['activeProductsServices'] = "منتجاتك/خدماتك المفعّلة";
$_LANG['clientHomePanels']['activeProductsServicesNone'] = "يبدوا أنه لا يوجد لديك أي منتجات/خدمات لدينا بعد. <a href=\"cart.php\">تقدم بطلبك</a>.";
$_LANG['clientHomePanels']['recentNews'] = "جديد الأخبار";
$_LANG['clientHomePanels']['affiliateProgram'] = "برنامج الأرباح";
$_LANG['clientHomePanels']['recentSupportTickets'] = "جديد تذاكر الدعم الفني";
$_LANG['clientHomePanels']['recentSupportTicketsNone'] = "لم يتم العثور على تذاكر جديدة. إن كنت بحاجة لمساعدة, يرجى <a href=\"submitticket.php\">فتح تذكرة جديدة</a>.";
$_LANG['clientHomePanels']['affiliateSummary'] = "إجمالي أرباحك الحالية هو :commissionBalance. تحتاج إلى :amountUntilWithdrawalLevel قبل أن تسطيع سحب المبلغ.";

$_LANG['upgradeNotPossible'] = "ترقية هذا المنتج غير ممكنة.  إذا كنت تظن أنك وصلت لهذه الصفحة بالخطة, يرجى إبلاغ الدعم الفني بذلك.  غير ذلك, عد للخلف وتأكد من اختيارك.";

$_LANG['hostingInfo'] = "بيانات الإستضافة";
$_LANG['additionalInfo'] = "بيانات إضافية";
$_LANG['resourceUsage'] = "استهلاك الموارد";
$_LANG['primaryIP'] = "الآي بي الأساسي";
$_LANG['assignedIPs'] = "الآي بي المسجلة";
$_LANG['diskSpace'] = "مساحة القرص";
$_LANG['bandwidth'] = "الباندويدث";
$_LANG['registered'] = "مسجل";
$_LANG['upgrade'] = "ترقية";

$_LANG['downdoadsdesc'] = "كتبيات, برامج, وملفات أخرى";

$_LANG['doToday'] = "ماذا ترغب بأن تفعل؟";
$_LANG['changeDomainNS'] = "تعديل توجيه أسماء الخوادم لنطاقك";
$_LANG['updateWhoisContact'] = "تحديث بيانات المسجل لنطاقك";
$_LANG['changeRegLock'] = "تعديل حالة الاقفال الخاصة بالمسجل لنطاقك";
$_LANG['renewYourDomain'] = "تجديد نطاقك";

$_LANG['oops'] = "نأسف";
$_LANG['goback'] = "عودة";
$_LANG['returnhome'] = "العودة للرئيسية";
$_LANG['blankCustomField'] = "(لا قيمة)";

$_LANG['viewAll'] = "عرض الكل";
$_LANG['moreDetails'] = "مزيد من التفاصيل";

$_LANG['clientHomeSearchKb'] = "أدخل سؤال هنا للبحث عن إجابة بقاعدة المعرفة الخاصة بنا...";

$_LANG['whoisContactWarning'] = "من الضروري الحفاظ على بيانات مسجل النطاق محدثة للحفاظ على امكانية التحكم بالنطاق.";

$_LANG['paymentstodate'] = "المدفوعات حتى تاريخه";
$_LANG['balancedue'] = "المبلغ المستحق";
$_LANG['submitpayment'] = "اعتماد الدفع";

$_LANG['domaincheckeravailable'] = "متاح";
$_LANG['domaincheckertransferable'] = "متاح للنقل";
$_LANG['domaincheckertaken'] = "محجوز";
$_LANG['domaincheckeradding'] = "جاري الإضافة";
$_LANG['domaincheckeradded'] = "تمت الإضافة";
$_LANG['domaincheckernomoresuggestions'] = "هذه كل النتائج التي نستطيع تقديمها لك! إن لم تجد ما تبحث عنه بعد, يرجى التجربة باستخدام كلمة بحث أخرى.";
$_LANG['domaincheckerunabletooffertld'] = "للأسف لا نستطيع حجز هذا الامتداد بالوقت الحالي";
$_LANG['domaincheckerbulkplaceholder'] = "أدخل لغاية 20 نطاق.\nيجب أن يكون كل نطاق بسطر منفصل.\n\nأمثلة:\nexample.com\nexample.net";

$_LANG['domainchecker']['suggestiontakentitle'] = "النطاق غير متاح";
$_LANG['domainchecker']['suggestiontakenmsg'] = "للأسف النطاق الذي اخترته غير متاح. قد يحدث هذا في حال كان النطاق محجوزاً. يرجى العودة واختيار نطاق آخر.";
$_LANG['domainchecker']['suggestiontakenchooseanother'] = "اختر نطاق آخر";

$_LANG['domainchecker']['alreadyincarttitle'] = "موجود بسلة الشراء مسبقاً";
$_LANG['domainchecker']['alreadyincartmsg'] = "تم إضافة هذا النطاق لسلة الشراء مسبقاً. ابدأ بعملية الدفع الآن لاتمام حجزه.";
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "اتمام الدفع الآن";

$_LANG['genericerror']['title'] = "نأسف, حدث خطأ!";
$_LANG['genericerror']['msg'] = "يرجى المحاولة مرة أخرى وفي حال استمرت المشكلة, يرجى مراسلة الدعم الفني.";

# Licensing Addon

$_LANG['licensingaddon']['mylicenses'] = "تراخيصي";
$_LANG['licensingaddon']['latestdownload'] = "آخر تحميل";
$_LANG['licensingaddon']['downloadnow'] = "تحميل الآن";
...
$_LANG['affiliateWithdrawalSummary'] = "تستطيع سحب رصيدك من الأرباح فور وصوله للحد الأدني المسموح به :amountForWithdrawal.";

$_LANG['projectManagement']['activeProjects'] = "مشاريعك الفعّالة";

# cPanel Module

$_LANG['cPanel']['packageDomain'] = "الباقية/النطاق";
$_LANG['cPanel']['addonsExtras'] = "الإضافات";
$_LANG['cPanel']['purchaseActivate'] = "شراء وتفعيل";

$_LANG['cPanel']['usageStats'] = "إحصائيات الاستخدام";
$_LANG['cPanel']['diskUsage'] = "استخدام المساحة";
$_LANG['cPanel']['bandwidthUsage'] = "استخدام الباندويدث";
$_LANG['cPanel']['usageStatsBwLimitNear'] = "أنت تقترب من استهلاك الباندويدث الخاص بك.";
$_LANG['cPanel']['usageStatsDiskLimitNear'] = "أنت تقترب من استهلاك المساحة الخاصة بك.";
...
$_LANG['cPanel']['createEmailAccount'] = "الإنشاء السريح لحسابات البريد الإلكتروني";
$_LANG['cPanel']['usernamePlaceholder'] = "الاسم";
$_LANG['cPanel']['passwordPlaceholder'] = "كلمة المرور المطلوبة";
$_LANG['cPanel']['create'] = "إنشاء";
$_LANG['cPanel']['emailAccountCreateSuccess'] = "تم إنشاء البريد الإلكتروني بنجاح!";
$_LANG['cPanel']['emailAccountCreateFailed'] = "فشل بإنتشاء البريد الإلكتروني: ";

$_LANG['cPanel']['packageNotActive'] = "باقة الاستضافة حالياً";
$_LANG['cPanel']['statusPendingNotice'] = "لا يمكنك استخدام حساب الاستضافة هذا الا في حال تفعيله.";
$_LANG['cPanel']['statusSuspendedNotice'] = "لا يمكنك الاستمرار بالتحكم بحساب الاستضافة الحالي الا بعد إعادة تفعيله.";

$_LANG['cPanel']['billingOverview'] = "نظرة عامة على المدفوعات";

$_LANG['liveHelp']['chatNow'] = "المحادثة الآن";

$_LANG['quotes'] = "عروض الأسعار";

$_LANG['productMustBeActiveForModuleCmds'] = "يجب أن يكون المنتج مفعّل لإجراء هذه العملية";
$_LANG['domainCannotBeManagedUnlessActive'] = "هذا النطاق غير مفعل حالياً. لا يمكن التحكم بالنطاقات الا في حال تفعيلها.";

$_LANG['actionRequiresAtLeastOneDomainSelected'] = "Please select at least one domain to perform the selected action on.";

$_LANG['clientAreaProductDownloadsAvailable'] = "عنصر التحميل التالي متاح لمنتجك/خدمتك";
$_LANG['clientAreaProductAddonsAvailable'] = "الإضافات المتاحة لمنتجك/خدمتك. <a href=\"cart.php?gid=addons\">اضغط هنا للعرض و الطلب &raquo;</a>";
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "نحن ننصحك بشدة لتفعيل خاصة إثبات المصادقة لمزيد من الحماية.";
$_LANG['clientAreaSecurityNoSecurityQuestions'] = "إضافة أسئلة وأجوبة الحماية تحمي حسابك من عمليات استرجاع كلمات المرور المشبوهة وتساعدنا لاتمام اي تعديلات تطلبها لحسابك.";
$_LANG['clientAreaSecuritySecurityQuestionOtherError'] = "إضافة أسئلة وأجوبة الحماية تحمي حسابك من عمليات استرجاع كلمات المرور المشبوهة وتساعدنا لاتمام اي تعديلات تطلبها لحسابك.";
