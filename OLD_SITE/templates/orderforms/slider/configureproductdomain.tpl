...
<div class="domainresults" id="domainresults"><img src="{$BASE_PATH_IMG}/loading.gif" border="0" alt="Loading..." /></div>
</form>
</div>
...
function cancelcheck() {
    jQuery("#domainpopupcontainer").slideUp('slow',function() {
        ...
        jQuery("#domainresults").html('<img src="{/literal}{$BASE_PATH_IMG}{literal}/loading.gif" border="0" alt="Loading..." />');
    });
}
function completedomain() {
    jQuery("#domainresults").append('<img src="{/literal}{$BASE_PATH_IMG}{literal}/loading.gif" border="0" alt="Loading..." />');
