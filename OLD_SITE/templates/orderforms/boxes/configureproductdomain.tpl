                    ...
                    {if $registerdomainenabled}
                        <div class="field-row clearfix">
                            ...
                            <div class="row domain-option line-padded{if $domainoption neq "register"} hidden{/if}" id="domopt-register">
                                ...
                                <div class="col-sm-5 col-xs-6"><input type="text" name="sld[0]" value="{$sld}" class="form-control" /></div>
                    ...
                    {if $transferdomainenabled}
                        <div class="field-row clearfix">
                            ...
                            <div class="row domain-option line-padded{if $domainoption neq "transfer"} hidden{/if}" id="domopt-transfer">
                                <div class="col-sm-1 col-sm-offset-2 col-xs-3"><p class="form-control-static text-right">www.</p></div>
                                <div class="col-sm-5 col-xs-6"><input type="text" name="sld[1]" value="{$sld}" class="form-control" /></div>
                    ...
                    {if $owndomainenabled}
                        <div class="field-row clearfix">
                            ...
                            <div class="row domain-option line-padded{if $domainoption neq "owndomain"} hidden{/if}" id="domopt-owndomain">
                                <div class="col-sm-1 col-sm-offset-2 col-xs-3"><p class="form-control-static text-right">www.</p></div>
                                <div class="col-sm-5 col-xs-6"><input type="text" name="sld[2]" value="{$sld}" class="form-control" /></div>
                                <div class="col-sm-2 col-xs-3"><input type="text" name="tld[2]" value="{$tld|substr:1}" class="form-control" /></div>
                            </div>
                        </div>
                    {/if}
                        ...
                        <div class="field-row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="domain-option line-padded{if $domainoption neq "subdomain"} hidden{/if}" id="domopt-subdomain">
                                    ...
                                    <div class="col-sm-3 col-xs-3"><input type="text" name="sld[3]" value="{$sld}" class="form-control" /></div>
