            ...
            <div id="loginContainer"{if $loggedin || $custtype neq "existing"} class="hidden"{/if}>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="email" name="loginemail" id="inputLoginEmail" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
            ...
            {if $shownotesfield}
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <textarea name="notes" rows="4" class="form-control" onFocus="if(this.value=='{$LANG.ordernotesdescription}'){ldelim}this.value='';{rdelim}" onBlur="if (this.value==''){ldelim}this.value='{$LANG.ordernotesdescription}';{rdelim}">{$notes}</textarea>
                    </div>
                </div>
            {/if}
