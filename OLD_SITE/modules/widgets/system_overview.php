...
<div class="row">
    <div class="col-sm-3 text-center">' . AdminLang::trans('clients.title') . '</div>
    <div class="col-sm-6">
        <div class="progress">
            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ' . $clientsactive . '%">
                ' . $clientsactive . '% ' . AdminLang::trans('status.active') . '
            </div>
        </div>
    </div>
    <div class="col-sm-3 text-center">' . $totalclients . '</div>
</div>
<div class="row">
    <div class="col-sm-3 text-center">' . AdminLang::trans('services.title') . '</div>
    <div class="col-sm-6">
        <div class="progress">
            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ' . $servicesactive . '%">
                ' . $servicesactive . '% ' . AdminLang::trans('status.active') . '
            </div>
        </div>
    </div>
    <div class="col-sm-3 text-center">' . $totalservices . '</div>
</div>
<div class="row">
    <div class="col-sm-3 text-center">' . AdminLang::trans('stats.unpaidinvoices') . '</div>
    <div class="col-sm-6">
        <div class="progress">
            <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ' . $overduestatus . '%">
                ' . $overduestatus . '% ' . AdminLang::trans('status.overdue') . '
            </div>
        </div>
    </div>
    <div class="col-sm-3 text-center">' . $unpaidinvoices . '</div>
</div>
';
        exit;
