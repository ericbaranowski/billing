...
# Global
$_ADMINLANG['global']['hometitle'] = "Панель администратора";
...
$_ADMINLANG['home']['maintenancemode'] = "Включен профилактический режим. По завершении не забудьте отключить его в <a href=\"configgeneral.php\" class=\"underline\">Общих настройках</a>";
...
$_ADMINLANG['clients']['ccdeletesure'] = "Вы уверены, что хотите удалить текущие данные кредитной карты?";
$_ADMINLANG['clients']['closesure'] = "Вы уверены, что хотите закрыть клиента? Этим вы установите статус 'Отменено' для всех его продуктов и неоплаченных счетов.";
$_ADMINLANG['clients']['deletesure'] = "Вы уверены, что хотите удалить клиента? Это подразумевает безвозвратное удаление всех его данных.";
...
$_ADMINLANG['clients']['2faenabled'] = "Включено - Отметьте, чтобы отключить";
$_ADMINLANG['clients']['ccstoredisabled'] = "Хранение кредитных данных отключено";
...
$_ADMINLANG['clientsummary']['emails'] = "Письма";
...
$_ADMINLANG['clientsummary']['emailsheading'] = "Последние письма";
$_ADMINLANG['clientsummary']['sendemailheading'] = "Отправить письмо";
...
$_ADMINLANG['clientsummary']['filedeletesure'] = "Вы уверены, что хотите удалить этот файл?";
...
$_ADMINLANG['services']['noproductsinfo'] = "На данный момент у этого пользователя нет продуктов/услуг.  <a href=\"ordersadd.php?userid=\" class=\"underline\">Нажмите здесь</a> для добавления нового заказа.";
...
$_ADMINLANG['services']['createsure'] = "Вы уверены, что хотите выполнить функцию создания?";
$_ADMINLANG['services']['suspendsure'] = "Вы уверены, что хотите выполнить функцию приостановки?";
...
$_ADMINLANG['services']['unsuspendsure'] = "Вы уверены, что хотите выполнить функцию возобновления?";
$_ADMINLANG['services']['terminatesure'] = "Вы уверены, что хотите выполнить функцию удаления?";
$_ADMINLANG['services']['chgpacksure'] = "Вы уверены, что хотите выполнить функцию смены пакета?";
$_ADMINLANG['services']['proddeletesure'] = "Вы уверены, что хотите удалить данную услугу? При этом будут удалены и ее дополнения без выполнения модульной команды.";
...
$_ADMINLANG['addons']['areyousuredelete'] = "Вы уверены, что хотите удалить дополнение?";
...
$_ADMINLANG['addons']['autoactpaymentinfo'] = "Автоматически активировать и отправить письмо с деталями по факту оплаты";
...
$_ADMINLANG['domains']['registrant'] = "Данные регистранта";
...
$_ADMINLANG['domains']['nameserver'] = "Неймсервер";
...
$_ADMINLANG['domains']['autonsdesc1'] = "Неймсервера с сервера хостинг-аккаунта";
$_ADMINLANG['domains']['autonsdesc2'] = "Неймсервера по умолчанию";
$_ADMINLANG['domains']['autonsdesc3'] = "Неймсервера, указанные при заказе";
$_ADMINLANG['domains']['actionreg'] = "Регистрация";
$_ADMINLANG['domains']['ifreq'] = "Если требуется";
$_ADMINLANG['domains']['sendregisterconfirm'] = "Выберите, чтобы отправить письмо с подтверждением регистрации при успешном завершении";
...
$_ADMINLANG['domains']['actionquestion'] = "Вы уверены, что хотите выполнить действие: %s домена?";
...
$_ADMINLANG['domains']['dnsmanagementadded'] = "Управление DNS добавлено для данного домена с изменением его стоимости";
$_ADMINLANG['domains']['emailforwardingadded'] = "Пересылка почты добавлена для данного домена с изменением его стоимости";
$_ADMINLANG['domains']['idprotectionadded'] = "Защита ID добавлена для данного домена с изменением его стоимости";
$_ADMINLANG['domains']['dnsmanagementremoved'] = "Управление DNS отключено для данного домена со снижением его стоимости";
$_ADMINLANG['domains']['emailforwardingremoved'] = "Пересылка почты отключена для данного домена со снижением его стоимости";
$_ADMINLANG['domains']['idprotectionremoved'] = "Защита ID отключена для данного домена со снижением его стоимости";
$_ADMINLANG['domains']['nschangefail'] = "Изменить неймсервера не удалось";
$_ADMINLANG['domains']['nschangesuccess'] = "Неймсервера успешно изменены";
$_ADMINLANG['domains']['nschangeinfo'] = "Запрос изменения неймсерверов принят регистратором";
$_ADMINLANG['domains']['resetdefaultns'] = "Выберите для применения неймсерверов по умолчанию";
...
$_ADMINLANG['domains']['renewdomainq'] = "Вы уверены, что хотите отправить регистратору запрос о продлении домена ?";
$_ADMINLANG['domains']['requestepp'] = "Запрос EPP кода";
$_ADMINLANG['domains']['requesteppq'] = "Вы уверены, что хотите отправить запрос EPP кода регистратору?";
$_ADMINLANG['domains']['requestdel'] = "Запрос удаления домена";
$_ADMINLANG['domains']['requestdelq'] = "Вы уверены, что хотите отправить регистратору запрос об удалении домена?";
$_ADMINLANG['domains']['delete'] = "Удалить домен";
$_ADMINLANG['domains']['deleteq'] = "Вы уверены, что хотите удалить этот домен?";
...
$_ADMINLANG['domains']['slabsintro'] = "Вы можете создавать разные варианты цен для групп клиентов. Сначала установите стандартный набор цен, а затем, при необходимости, дополнительные цены для одной или нескольких групп клиентов";
...
$_ADMINLANG['domains']['activatepricingslabconfirm'] = "Вы уверены, что хотите активировать новый набор цен?";
$_ADMINLANG['domains']['deactivatepricingslab'] = "Отключить набор цен";
$_ADMINLANG['domains']['deactivatepricingslabconfirm'] = "Вы уверены, что хотите отключить этот набор цен?";
$_ADMINLANG['domains']['resetpricingslab'] = "Вернуть стандартный набор цен";
$_ADMINLANG['domains']['resetpricingslabconfirm'] = "Вы уверены, что хотите установить для этого набора стандартные цены?";
...
$_ADMINLANG['orders']['confirmcancel'] = "Вы уверены, что хотите удалить этот заказ? Данное действие запускает команду удаления соответствующих продуктов/услуг.";
$_ADMINLANG['orders']['confirmcancelrefund'] = "Вы уверены, что хотите удалить этот заказ с возвратом средств? Данное действие запускает команду удаления соответствующих продуктов/услуг.";
$_ADMINLANG['orders']['confirmfraud'] = "Вы уверены, что хотите удалить этот заказ как мошеннический? Данное действие запускает команду удаления соответствующих продуктов/услуг.";
$_ADMINLANG['orders']['confirmpending'] = "Вы уверены, что хотите вернуть этот заказ в ожидающие?";
$_ADMINLANG['orders']['confirmdelete'] = "Вы уверены, что хотите удалить этот заказ? При этом будут удалены все связанные с ним продукты и счета.";
$_ADMINLANG['orders']['checkfreeemail'] = "Проверить, свободен ли Email аккаунт";
...
$_ADMINLANG['orders']['sendwelcome'] = "Отправить email с деталями";
$_ADMINLANG['orders']['sendtoregistrar'] = "Запрос регистратору";
$_ADMINLANG['orders']['sendconfirmation'] = "Отправить email с подтверждением";
$_ADMINLANG['orders']['nameservers'] = "Неймсервера";
...
$_ADMINLANG['billingcycles']['onetime'] = "Единожды";
...
$_ADMINLANG['billing']['incomethismonth'] = "За текущий месяц";
$_ADMINLANG['billing']['incomethisyear'] = "За текущий год";
...
$_ADMINLANG['invoices']['delete'] = "Вы уверены, что хотите удалить этот счет (при регулярной оплате на одну и ту же дату нельзя выписать счет дважды)?";
...
$_ADMINLANG['invoices']['sendcreated'] = "Письмо о создании счета";
$_ADMINLANG['invoices']['sendconfirmation'] = "Письмо с подтверждением оплаты";
...
$_ADMINLANG['invoices']['ticksendconfirmation'] = "Выберите для отправки письма с подтверждением";
...
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Вы уверены, что хотите удалить выбранные счета?";
...
$_ADMINLANG['billableitems']['itemsdeletequestion'] = "Вы уверены, что хотите удалить этот оплачиваемый элемент?";
...
$_ADMINLANG['billableitems']['invoiceselected'] = "Выписать счет";
...
$_ADMINLANG['billableitems']['noclientsmsg'] = "Перед добавлением оплачиваемого элемента необходимо <a href=\"clientsadd.php\" class=\"underline\">создать профиль клиента</a>";
...
$_ADMINLANG['quotes']['deletesure'] = "Вы уверены, что хотите удалить это предложение?";
...
$_ADMINLANG['support']['announcesuredel'] = "Вы уверены, что хотите удалить это оповещение?";
...
$_ADMINLANG['support']['dldelsure'] = "Вы уверены, что хотите удалить этот файл?";
$_ADMINLANG['support']['dlcatdelsure'] = "Вы уверены, что хотите удалить эту категорию? При этом будут удалены все ее файлы.";
...
$_ADMINLANG['support']['kbdelsure'] = "Вы уверены, что хотите удалить эту статью базы знаний?";
$_ADMINLANG['support']['kbcatdelsure'] = "Вы уверены, что хотите удалить эту категорию  базы знаний? При этом будут удалены все ее статьи.";
...
$_ADMINLANG['support']['predefdeletecat'] = "Выбрання категория успешно удалена";
$_ADMINLANG['support']['predefdelsure'] = "Вы уверены, что хотите удалить этот готовый ответ?";
$_ADMINLANG['support']['predefdelcatsure'] = "Вы уверены, что хотите удалить эту категорию готовых ответов? При этом будут удалены все ее ответы.";
...
$_ADMINLANG['support']['spamupdatefailed'] = "Не удалось обновить спам-контроль";
$_ADMINLANG['support']['spamupdatefailedinfo'] = "Этот email адрес уже добавлен в список заблокированных отправителей";
$_ADMINLANG['support']['spamupdatesuccess'] = "Спам контроль успешно обновлен";
$_ADMINLANG['support']['spamupdatesuccessinfo'] = "Email адрес %s успешно добавлен в список заблокированных отправителей";
...
$_ADMINLANG['support']['massmergeconfirm'] = "Вы уверены, что хотите объединить выбранные тикеты?";
$_ADMINLANG['support']['masscloseconfirm'] = "Вы уверены, что хотите закрыть выбранные тикеты?";
$_ADMINLANG['support']['massdeleteconfirm'] = "Вы уверены, что хотите удалить выбранные тикеты??";
$_ADMINLANG['support']['massblockdeleteconfirm'] = "Вы уверены, что хотите закрыть выбранные тикеты и заблокировать отправителей?";
...
$_ADMINLANG['support']['delreplysure'] = "Вы уверены, что хотите удалить этот ответ в тикет?";
$_ADMINLANG['support']['delticketsure'] = "Вы уверены, что хотите удалить этот тикет и все его ответы?";
$_ADMINLANG['support']['delnotesure'] = "Вы уверены, что хотите удалить это примечание?";
$_ADMINLANG['support']['delattachment'] = "Вы уверены, что хотите удалить это приложение?";
$_ADMINLANG['support']['statuschanged'] = "Статус тикета изменился с тех пор, как вы начали отвечать. Возможно, другой сотрудник уже ответил в тикет.";
$_ADMINLANG['support']['stillsubmit'] = "Вы уверены, что все же хотите отправить свой ответ?";
...
$_ADMINLANG['support']['ccrecipients'] = "Адреса получателей";
...
# Browser
$_ADMINLANG['browser']['bookmarks'] = "Закладки";
$_ADMINLANG['browser']['addnew'] = "Добавить новую закладку";
$_ADMINLANG['browser']['sitename'] = "Имя сайта";
$_ADMINLANG['browser']['url'] = "URL";
$_ADMINLANG['browser']['add'] = "Добавить";
$_ADMINLANG['browser']['deleteq'] = "Вы уверены, что хотите удалить эту закладку?";
...
$_ADMINLANG['currencies']['delsure'] = "Вы уверены, что хотите удалить эту валюту?";
$_ADMINLANG['currencies']['exchrateupdate'] = "Результат обновления курсов валют";
$_ADMINLANG['currencies']['updatedpricing'] = "Обновленные цены";
...
$_ADMINLANG['affiliates']['deletesure'] = "Вы уверены, что хотите удалить этого партнера?";
...
$_ADMINLANG['affiliates']['refdeletesure'] = "Вы уверены, что хотите удалить этого партнерского клиента?";
$_ADMINLANG['affiliates']['comdeletesure'] = "Вы уверены, что хотите удалить эту ожидающую комиссию?";
$_ADMINLANG['affiliates']['pytdeletesure'] = "Вы уверены, что хотите удалить эту запись истории платежей?";
$_ADMINLANG['affiliates']['witdeletesure'] = "Вы уверены, что хотите удалить эту запись о выплате?";
...
$_ADMINLANG['setup']['twofa'] = "Двухэтапная авторизация";
...
$_ADMINLANG['setup']['spam'] = "Спам контроль";
...
$_ADMINLANG['setup']['bannedemails'] = "Заблокированные Email";
...
# Help
$_ADMINLANG['help']['title'] = "Справка";
$_ADMINLANG['help']['docs'] = "Документация";
$_ADMINLANG['help']['videotutorials'] = "Видео уроки";
$_ADMINLANG['help']['licenseinfo'] = "Информация о лицензии";
$_ADMINLANG['help']['changelicense'] = "Изменить лицензию";
$_ADMINLANG['help']['updates'] = "Проверить обновление";
$_ADMINLANG['help']['support'] = "Запрос поддержки";
$_ADMINLANG['help']['forums'] = "Форум сообщества";
$_ADMINLANG['help']['contextlink'] = "Справка";
...
$_ADMINLANG['fields']['promocode'] = "Акционный код";
...
$_ADMINLANG['fields']['hidden'] = "Скрыто";
...
$_ADMINLANG['fields']['nameserver'] = "Неймсервер";
...
$_ADMINLANG['contactpermissions']['permemails'] = "Просматривать письма";
...
$_ADMINLANG['permissions']['105'] = "Просмотр отдельных тикетов";
$_ADMINLANG['permissions']['121'] = "Просмотр всех тикетов";
$_ADMINLANG['permissions']['82'] = "Список назначенных тикетов";
...
$_ADMINLANG['permissions']['48'] = "Браузер";
...
$_ADMINLANG['permissions']['127'] = "Настройка двухэтапной авторизации";
...
$_ADMINLANG['permissions']['116'] = "Создание новых продуктов/услуш";
...
# Addon Modules
$_ADMINLANG['addonmodules']['choose'] = "Выберите дополнительный модуль из приведенных ниже";
...
$_ADMINLANG['addonmodules']['deactivatesure'] = "Вы уверены, что хотите отключить этот модуль?";
...
$_ADMINLANG['credit']['deleteq'] = "Вы уверены, что хотите удалить этот кредит и вычесть его сумму из кредитного баланса клиента?";
...
$_ADMINLANG['calendar']['onceonly'] = "Единожды";
...
$_ADMINLANG['calendar']['duepayments'] = "Оплатить";
$_ADMINLANG['calendar']['dueaddonpayments'] = "Оплатить дополнения";
$_ADMINLANG['calendar']['expiringdomains'] = "Продлить домены";
...
# Emails
$_ADMINLANG['emails']['viewemail'] = "Открыть Email";
$_ADMINLANG['emails']['newmessage'] = "Новое сообщение";
$_ADMINLANG['emails']['registeredemail'] = "Зарегистрированный email";
...
$_ADMINLANG['emails']['suredelete'] = "Вы уверены, что хотите удалить этот Email?";
$_ADMINLANG['emails']['nosubject'] = "Без темы";
$_ADMINLANG['emails']['resendemail'] = "Переслать Email";
$_ADMINLANG['emails']['from'] = "От";
$_ADMINLANG['emails']['recipients'] = "Получатели";
$_ADMINLANG['emails']['senddefaultproductwelcome'] = "Переслать Email с деталями продукта";

# Transactions
$_ADMINLANG['transactions']['deletesure'] = "Вы уверены, что хотите удалить эту транзакцию?";
...
$_ADMINLANG['products']['welcomeemail'] = "Email с деталями";
...
$_ADMINLANG['products']['duplicateproduct'] = "Копировать продукт";
$_ADMINLANG['products']['deleteproductconfirm'] = "Вы уверены, что хотите удалить данный продукт?";
$_ADMINLANG['products']['deletegroupconfirm'] = "Вы уверены, что хотите удалить данную группу продуктов?";
$_ADMINLANG['products']['deletecustomfieldconfirm'] = "Вы уверены, что хотите удалить данное поле и ВСЕ ДАННЫЕ с ним связанные?";
$_ADMINLANG['products']['deleteproductconfigconfirm'] = "Вы уверены, что хотите удалить данную настройку продукта?";
...
$_ADMINLANG['products']['terminationemail'] = "Email об удалении";
...
$_ADMINLANG['products']['upgradeemail'] = "Email о смене пакета";
...
$_ADMINLANG['products']['freedomaintlds'] = "TLD бесплатного домена";
$_ADMINLANG['products']['customaffiliatepayout'] = "Специальная выплата партнеру";
$_ADMINLANG['products']['subdomainoptions'] = "Виды сабдоменов";
$_ADMINLANG['products']['subdomainoptionsdesc'] = "Введите в формате .vashdomen.com (несколько вариантов отделяйте запятыми)";
...
$_ADMINLANG['products']['overagesbilling'] = "Счет за превышение квот";
...
# Downloads
$_ADMINLANG['downloads']['ctrlmultiple'] = "Используйте Ctrl + Щелчок для выбора нескольких загрузок";

# Admin Roles
$_ADMINLANG['adminroles']['suredelete'] = "Вы уверены, что хотите удалить данную группу администраторов?";
...
$_ADMINLANG['adminroles']['deletesuccess'] = "Администратор успешно удален!";
$_ADMINLANG['adminroles']['deletesuccessinfo'] = "Выбранный аккаунт администратора был удален из системы";
...
$_ADMINLANG['administrators']['deletesure'] = "Вы уверены, что хотите удалить этого администратора?";
...
$_ADMINLANG['administrators']['disableinfo'] = "Выберите, чтобы запретить отправку email-сообщения";
...
$_ADMINLANG['automation']['unpaidreminderinfo'] = "Укажите, за сколько дней до даты платежа по счету вы хотите высылать напоминание";
$_ADMINLANG['automation']['todisable'] = "0, чтобы не высылать";
$_ADMINLANG['automation']['firstreminder'] = "Первое напоминание о просроченной оплате";
$_ADMINLANG['automation']['firstreminderinfo'] = "Укажите, сколько дней спустя вы хотите высылать первое напоминание о просроченном счете";
$_ADMINLANG['automation']['secondreminder'] = "Второе напоминание о просроченной оплате";
$_ADMINLANG['automation']['secondreminderinfo'] = "Укажите, сколько дней спустя вы хотите высылать второе напоминание о просроченном счете";
$_ADMINLANG['automation']['thirdreminder'] = "Третье напоминание о просроченной оплате";
$_ADMINLANG['automation']['thirdreminderinfo'] = "Укажите, сколько дней спустя вы хотите высылать третье (последнее) напоминание о просроченном счете";
...
$_ADMINLANG['automation']['ccexpirynoticesinfo'] = "Укажите, какого числа месяца высылать уведомления владельцам карт, действительных до следующего месяца";
...
$_ADMINLANG['automation']['firstrenewalinfo'] = "Укажите, за сколько дней %s продления домена высылается первое напоминание";
$_ADMINLANG['automation']['secondrenewal'] = "Второе напоминание о продлении";
$_ADMINLANG['automation']['secondrenewalinfo'] = "Укажите, за сколько дней %s продления домена высылается второе напоминание";
$_ADMINLANG['automation']['thirdrenewal'] = "Третье напоминание о продлении";
$_ADMINLANG['automation']['thirdrenewalinfo'] = "Укажите, за сколько дней %s продления домена высылается третье напоминание";
$_ADMINLANG['automation']['fourthrenewal'] = "Четвертое напоминание о продлении";
$_ADMINLANG['automation']['fourthrenewalinfo'] = "Укажите, за сколько дней %s продления домена высылается четвертое напоминание";
$_ADMINLANG['automation']['fifthrenewal'] = "Пятое напоминание о продлении";
$_ADMINLANG['automation']['fifthrenewalinfo'] = "Укажите, за сколько дней %s продления домена высылается пятое напоминание";
...
$_ADMINLANG['gateways']['nonesetup'] = "Для продолжения необходимо активировать хотя бы один платежный шлюз на странице <a href=\"configgateways.php\" class=\"underline\">>Настройки платежных шлюзов</a>.";
...
$_ADMINLANG['backups']['emailinfo'] = "Введите email адрес, на который хотите высылать файл с копией";
...
$_ADMINLANG['backups']['hostnameinfo'] = "напр. ftp.vashdomen.com";
...
$_ADMINLANG['backups']['zipExtensionRequired'] = "The <a href='http://php.net/manual/ru/book.zip.php'>PHP Zip Extension</a> is required to utilise database backups.";
...
# License
$_ADMINLANG['license']['title'] = "Информация о лицензии";
$_ADMINLANG['license']['regto'] = "Зарегистрировано на";
...
$_ADMINLANG['license']['created'] = "Создан";
$_ADMINLANG['license']['expires'] = "Истекает";
$_ADMINLANG['license']['reissue1'] = "Если вы планируете переехать на новое место Вам будет необходимо переиздать заново лицензию.  Перейдите по ссылке";
$_ADMINLANG['license']['reissue2'] = "для получения дополнительной информации...";
$_ADMINLANG['license']['updateavailable'] = "Доступно обновление!";
...
$_ADMINLANG['bans']['ipdelsure'] = "Вы уверены, что хотите удалить данный IP адрес из списка заблокированных?";
...
$_ADMINLANG['customfields']['delsure'] = "Вы уверены, что хотите удалить данное поле вместе со ВСЕМИ ДАННЫМИ?";
...
$_ADMINLANG['emailtpls']['delsure'] = "Вы уверены, что хотите удалить данный Email шаблон?";
$_ADMINLANG['emailtpls']['info'] = "Стандартные email шаблоны, добавленные при установке системы, высылаются при определенном событии. Вы можете создавать свои шаблоны и отправлять их клиентам вручную или назначить в качестве писем с деталями продуктов.";
...
$_ADMINLANG['emailtpls']['plaintextinfo'] = "Выберите, чтобы отправлять письмо в формате простого текста";
$_ADMINLANG['emailtpls']['disableinfo'] = "Выберите, чтобы запретить отправку письма";
...
$_ADMINLANG['emailtpls']['typeaffiliate'] = "Партнерcкая программа";
...
$_ADMINLANG['mergefields']['ticketname'] = "Имя отправившего тикет";
$_ADMINLANG['mergefields']['ticketemail'] = "Email отправившего тикет";
...
$_ADMINLANG['mergefields']['nameserver'] = "Неймсервер";
...
$_ADMINLANG['mergefields']['ordernotes'] = "Примеч. к заказу";
...
$_ADMINLANG['general']['emailaddressinfo'] = "Адрес отправителя по умолчанию, используемый в письмах, высылаемых WHMCS";
...
$_ADMINLANG['general']['systemurlinfo'] = "URL инсталляции WHMCS, напр.";
$_ADMINLANG['general']['sslurl'] = "SSL URL системы WHMCS";
$_ADMINLANG['general']['sslurlinfo'] = "URL инсталляции WHMCS для безопасного доступа по SSL, напр.: https://www.yourdomain.com/members/ (оставьте пустым, если доступ по SSL не настроен)";
...
$_ADMINLANG['general']['tosurlinfo'] = "URL страницы с Условиями предоставления услуг на вашем сайте (напр.: http://www.yourdomain.com/tos.html)";
$_ADMINLANG['general']['autoredirect'] = "Действие по завершении заказа";
$_ADMINLANG['general']['noredirect'] = "Показать страницу завершения заказа (без направления к оплате)";
...
$_ADMINLANG['general']['noinvoiceemail'] = "Не высылать письмо со счетом";
$_ADMINLANG['general']['noinvoiceemailinfo'] = "Не высылать клиенту уведомление об оплате при создании нового заказа";
...
$_ADMINLANG['general']['emailcsscode'] = "CSS код письма";
...
$_ADMINLANG['general']['systemfromname'] = "Имя отправителя системных писем";
$_ADMINLANG['general']['systemfromemail'] = "Email адрес отправителя системных писем";
$_ADMINLANG['general']['bccmessages'] = "Скрытая копия";
$_ADMINLANG['general']['bccmessagesinfo'] = "Если вы хотите высылать скрытые копии всех отправленных системой писем на свой адрес, введите его здесь. Несколько адресов отделяйте запятыми (,)";
...
$_ADMINLANG['general']['feedbackreqs'] = "Запрос отзыва при закрытии тикета";
$_ADMINLANG['general']['feedbackreqsinfo'] = "Отправлять клиентам предложение оставить отзыв о качестве поддержки при закрытии тикетов";
...
$_ADMINLANG['general']['kbseourls'] = "Дружественные SEO URL базы знаний";
$_ADMINLANG['general']['kbseourlsinfo'] = "Включить дружественные SEO URL (необходимо переименовать файл корневой папки htaccess.txt в .htaccess)";
$_ADMINLANG['general']['allowedattachments'] = "Допустимые типы файлов вложений";
$_ADMINLANG['general']['allowedattachmentsinfo'] = "Вводя несколько расширений, отделяйте их запятыми";
...
$_ADMINLANG['general']['enablepdfinfo'] = "Отправлять в письмах со счетами PDF-версию счетов";
...
$_ADMINLANG['general']['groupsimilarlineitemsinfo'] = "Автоматически объединять в деталях счета идентичные услуги в формате *количество Х описание*";
$_ADMINLANG['general']['disableautocreditapply'] = "Отключить автоматическое применение кредита";
...
$_ADMINLANG['general']['captchaalwayson'] = "Всегда включена (графическое изображение кода из 5 цифр, воспринимаемого человеком)";
...
$_ADMINLANG['general']['captcharecaptcha'] = "reCAPTCHA (<a href=\"http://www.google.com/recaptcha\" target=\"_blank\" class=\"underline\">reCAPTCHA от Google</a>)";
...
$_ADMINLANG['general']['recaptchakeyinfo'] = "Требуется регистрация на <a href=\"https://www.google.com/recaptcha/admin/create\" target=\"_blank\" class=\"underline\">https://www.google.com/recaptcha/admin/create</a>";
...
$_ADMINLANG['general']['adminforcessl'] = "Принудительный админ-доступ по SSL";
$_ADMINLANG['general']['adminforcesslinfo'] = "Направлять все запросы в админ-панель по SSL";
...
$_ADMINLANG['general']['twitterannouncementstweet'] = "Оповещения в Tweeter";
...
$_ADMINLANG['general']['clientdetailsnotifyinfo'] = "Высылать администраторам email-уведомление о смене данных клиента";
...
$_ADMINLANG['general']['monthlyaffreportinfo'] = "Высылать партнерам отчет о приведенных за месяц клиентах 1-го числа каждого месяца";
...
$_ADMINLANG['taxconfig']['delsuretaxrule'] = "Нажмите Ок, если уверены, что хотите удалить это правило";
...
$_ADMINLANG['supportticketdepts']['deptaddsuccessdesc'] = "Помните, что дать каждому сотруднику доступ в новый отдел вы можете в разделе <a href=\"configadmins.php\" class=\"underline\">Настройка > Администраторы</a>";
...
$_ADMINLANG['supportticketdepts']['delsuredept'] = "Вы уверены, что хотите удалить данный отдел?";
$_ADMINLANG['supportticketdepts']['addnewdept'] = "Добавить новый отдел";
$_ADMINLANG['supportticketdepts']['editdept'] = "Редактировать отдел";
$_ADMINLANG['supportticketdepts']['delsurefielddata'] = "Вы уверены, что хотите удалить данное поле и ВСЕ ДАННЫЕ, с ним связанные?";
...
$_ADMINLANG['supportticketescalations']['delsureescalationrule'] = "Вы уверены, что хотите удалить это правило эскалации?";
$_ADMINLANG['supportticketescalations']['escalationrulesinfo'] = "Правила эскалации устанавливаются для выполнения автоматических действий с тикетами при наличии определенных критериев. Используются, чтобы гарантировать ответ в установленные сроки";
...
$_ADMINLANG['supportticketescalations']['notifyadminsdesc'] = "Высылать Email-уведомление администраторам нового отдела";

# To-Do List
$_ADMINLANG['todolist']['todolisttitle'] = "Список заданий";
$_ADMINLANG['todolist']['delsuretodoitem'] = "Вы уверены, что хотите удалить данное задание?";
...
$_ADMINLANG['utilitiesresolvercheck']['delsureterminateonserver'] = "Вы уверены, что хотите продолжить? Будет выполнена модульная команда удаления файлов на сервере, аккаунту WHMCS будет присвоен статус 'Удалено' с прекращением дальнейшего биллинга.";
...
$_ADMINLANG['sendmessage']['massmailspart1'] = " Общее количество писем к отправке - Шаг ";
...
$_ADMINLANG['sendmessage']['skippedduplicate'] = "Пропущена повторная отправка письма пользователю с ID ";
...
$_ADMINLANG['sendmessage']['noreceiptientsdesc'] = "Критерии рассылки таковы, что получателей не оказалось, и письмо не может быть отправлено";
$_ADMINLANG['sendmessage']['emailsentindividually1'] = "Письма высылаются индивидуально";
$_ADMINLANG['sendmessage']['emailsentindividually2'] = "так что получатели не узнают адреса друг друга";
$_ADMINLANG['sendmessage']['commaseparateemails'] = "Отделяйте адреса запятыми";
...
$_ADMINLANG['sendmessage']['massmailsetting2'] = "писем каждые";
...
$_ADMINLANG['sendmessage']['marketingemaildesc'] = "Не забудьте дать пользователям возможность отписаться от рассылки по ссылке %s, чтобы не нарушать CAN-SPAM Act";
$_ADMINLANG['sendmessage']['loadMessage'] = "Load Message";

# Support Ticket Spam Control
$_ADMINLANG['stspamcontrol']['stspamcontroltitle'] = "Спам фильтр тикетов поддержки";
$_ADMINLANG['stspamcontrol']['delsurespamcontrol'] = "Вы уверены, что хотите удалить данный фильтр?";
$_ADMINLANG['stspamcontrol']['spamcontrolupdatedtitle'] = "Спам фильтр обновлен!";
$_ADMINLANG['stspamcontrol']['spamcontrolupdatedadded'] = "Новый спам фильтр успешно добавлен!";
$_ADMINLANG['stspamcontrol']['spamcontrolupdateddel'] = "Спам фильтр успешно удален!";
$_ADMINLANG['stspamcontrol']['sender'] = "Отправитель";
$_ADMINLANG['stspamcontrol']['subject'] = "Тема";
$_ADMINLANG['stspamcontrol']['phrase'] = "Фраза";
$_ADMINLANG['stspamcontrol']['addnewsc'] = "Добавить новый спам фильтр";
...
$_ADMINLANG['ticketstatusconfig']['pagedesc'] = "Здесь вы можете настроить статусы тикетов вашей WHMCS. Четыре статуса по умолчанию нельзя удалить или переименовать: Открыт, Отвечен, Ответ клиента и Закрыт.";
...
$_ADMINLANG['ticketstatusconfig']['delsureticketstatus'] = "Вы уверены, что хотите удалить статус? При этом будут закрыты все тикеты с данным статусом .";
...
# Mass Mail
$_ADMINLANG['massmail']['pagedesc'] = "Здесь вы можете отправлять письма избранным группам клиентов. Тип письма определяет набор переменных, которые можно добавить в текст письма. Например, при составлении письма об услугах вы можете добавить такие переменные, как: домен, имя пользователя, сервер, дата следующего платежа, и т.п. Удерживайте Ctrl для выбора нескольких критериев рассылки.";
$_ADMINLANG['massmail']['messagetype'] = "Тип сообщения";
$_ADMINLANG['massmail']['emailtype'] = "Тип письма";
...
$_ADMINLANG['massmail']['footnote'] = "* По умолчанию, переменные из текста письма заменяются данными только одного продукта клиента. Если же включить данную опцию, полученное клиентом письмо будет содержать данные каждого из его продуктов, соответствующего критериям.";
...
$_ADMINLANG['promos']['deletesure'] = "Вы уверены, что хотите удалить этот промо-код?";
...
$_ADMINLANG['promos']['createpromo'] = "Создать специальный купон";
...
$_ADMINLANG['promos']['requiresexisting'] = "Разрешить использовать для существующих продуктов";
$_ADMINLANG['promos']['cycles'] = "Платежные циклы<br />(Не отмечайте, чтобы применять к любому)";
...
$_ADMINLANG['domainregistrars']['defaultns'] = "Неймсервера по умолчанию";
$_ADMINLANG['domainregistrars']['defaultns1'] = "Неймсервер 1";
$_ADMINLANG['domainregistrars']['defaultns2'] = "Неймсервер 2";
$_ADMINLANG['domainregistrars']['defaultns3'] = "Неймсервер 3";
$_ADMINLANG['domainregistrars']['defaultns4'] = "Неймсервер 4";
$_ADMINLANG['domainregistrars']['defaultns5'] = "Неймсервер 5";
...
$_ADMINLANG['bundles']['deletebundleconfirm'] = "Вы уверены, что хотите удалить это предложение?";
$_ADMINLANG['bundles']['removeitemconfirm'] = "Вы уверены, что хотите удалить этот элемент предложения?";
...
$_ADMINLANG['reports']['description'] = "В отчета ниже представлен анализ данных и, во многих случаях, графическое представление данных, хранящиеся в системе. Вы также можете создавать свои собственные отчеты. Нажмите значок справки для более подробной информации.";
...
$_ADMINLANG['whois']['available'] = "Домен %s достумен для регистрации";
$_ADMINLANG['whois']['error'] = "Проблема с соединением к whois-серверу.";
$_ADMINLANG['whois']['unavailable'] = "Домен %s уже зарегистрирован";
$_ADMINLANG['whois']['whois'] = "Данные WHOIS";

# Config Order Statuses
$_ADMINLANG['orderstatusconfig']['pagedesc'] = "Здесь вы можете определить дополнительные статусы заказов. Статусы по-умолчанию не могут быть удалены.";
...
$_ADMINLANG['orderstatusconfig']['editdesc'] = "Статус заказа добавлен успешно";
...
$_ADMINLANG['orderstatusconfig']['delsure'] = "Вы уверены, что хотите удалить этот статус? Всем заказам будет назначен статус Отменен.";
$_ADMINLANG['orderstatusconfig']['color'] = "Цвет статуса";
$_ADMINLANG['orderstatusconfig']['includeinpending'] = "Включить в ожидающий";
$_ADMINLANG['orderstatusconfig']['includeinactive'] = "Включить в активный";
$_ADMINLANG['orderstatusconfig']['includeincancelled'] = "Включить в отмененный";
...
$_ADMINLANG['configservers']['changesuccess'] = "Изменения успешно сохранены!";
...
# 2FA Security
$_ADMINLANG['twofa']['title'] = "Двухфакторная авторизация";
$_ADMINLANG['twofa']['introtext'] = "Двухфакторная авторизация создает дополнительный уровень защиты при авторизации. Если ее включить и настроить (для каждого администратора отдельно), для входа в систему потребуется ввести не только имя пользователя и пароль, но и дополнительный ключ, к примеру: код безопасности. Ниже приведены и другие способы двухфакторной авторизации.";
$_ADMINLANG['twofa']['enable'] = "Включить двухфакторную авторизацию";
$_ADMINLANG['twofa']['disable'] = "Отключить двухфакторную авторизацию";
$_ADMINLANG['twofa']['activateintro'] = "Двухфакторная авторизация создает дополнительный уровень защиты при авторизации. Включив ее, для входа в систему потребуется ввести не только имя пользователя и пароль, но и дополнительный ключ, к примеру: код безопасности.";
$_ADMINLANG['twofa']['disableintro'] = "Для отключения двухфакторной авторизации введите свой пароль адмнистратора.";
$_ADMINLANG['twofa']['choose'] = "Выберите второй фактор авторизации.";
$_ADMINLANG['twofa']['enforced'] = "Согласно настройкам системы, для продолжения необходимо включить двухфакторную авторизацию. На данной странице описана последовательность действий по ее активации.";
$_ADMINLANG['twofa']['getstarted'] = "Начать";
$_ADMINLANG['twofa']['activationerror'] = "При попытке включения двухфакторной авторизации произошла ошибка. Пожалуйста, попробуйте еще раз.";
$_ADMINLANG['twofa']['generalerror'] = "Произошла ошибка при загрузке модуля. Пожалуйста, попробуйте еще раз.";
$_ADMINLANG['twofa']['activationcomplete'] = "Установка двухфакторной авторизации завершена!";
$_ADMINLANG['twofa']['disabledconfirmation'] = "Двухфакторная авторизация для вашего аккаунта отключена.";
$_ADMINLANG['twofa']['backupcodeis'] = "Ваш резервный код:";
$_ADMINLANG['twofa']['backupcodeexpl'] = "Запишите его на бумаге и храните в безопасном месте.<br />Код может понадобиться при потере или отсутствии доступа к устройству дополнительной авторизации.";
