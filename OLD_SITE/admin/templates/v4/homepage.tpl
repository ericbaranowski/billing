<script type="text/javascript" src="{$BASE_PATH_JS}/jqueryag.js"></script>
                ...
                <div class="widget-content">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>{$licenseinfo.currentversion}{if $licenseinfo.updateavailable} <span class="textred"><b>{$_ADMINLANG.license.updateavailable}</b></span>{/if}</td>
                        </tr>
                        <tr>
