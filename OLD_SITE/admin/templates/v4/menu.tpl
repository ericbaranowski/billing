...
<li><a {if in_array("List Clients",$admin_perms)}href="clients.php"{/if} title="Clients" id="Menu-Clients">{$_ADMINLANG.clients.title}</a>
  <ul>
    {if in_array("List Clients",$admin_perms)}<li><a href="clients.php" id="Menu-Clients-View_Search_Clients">{$_ADMINLANG.clients.viewsearch}</a></li>{/if}
    {if in_array("Add New Client",$admin_perms)}<li><a href="clientsadd.php" id="Menu-Clients-Add_New_Client">{$_ADMINLANG.clients.addnew}</a></li>{/if}
    {if in_array("List Services",$admin_perms)}
    <li class="expand"><a href="clientshostinglist.php" id="Menu-Clients-Products_Services">{$_ADMINLANG.services.title}</a>
        <ul>
    ...
    {/if}
    {if in_array("List Addons",$admin_perms)}<li><a id="Menu-Clients-Service_Addons" href="clientsaddonslist.php">{$_ADMINLANG.services.listaddons}</a></li>{/if}
...
<li><a id="Menu-Support" {if in_array("Support Center Overview",$admin_perms)}href="supportcenter.php"{/if} title="Support">{$_ADMINLANG.support.title}</a>
  <ul>
    {if in_array("Manage Announcements",$admin_perms)}<li><a id="Menu-Support-Annoucements" href="supportannouncements.php">{$_ADMINLANG.support.announcements}</a></li>{/if}
...
{if in_array("Configure Currencies",$admin_perms) || in_array("Configure Payment Gateways",$admin_perms) || in_array("Configure Tax Setup",$admin_perms) || in_array("View Promotions",$admin_perms)}
    <li class="expand"><a id="Menu-Setup-Payments" href="#">{$_ADMINLANG.setup.payments}</a>
        ...
        {if in_array("Configure Tax Setup",$admin_perms)}<li><a id="Menu-Setup-Payments-Tax_Rules" href="configtax.php">{$_ADMINLANG.setup.tax}</a></li>{/if}
