...
<h2 class="pull-left">#{$tid} - {$subject} <select name="ticketstatus" id="ticketstatus" class="form-control select-inline">
...
<select name="postaction" class="form-control select-inline">
...
<input type="button" value="{$_ADMINLANG.support.insertpredef}" class="btn btn-default btn-sm" id="insertpredef" />
<input type="button" value="{$_ADMINLANG.support.insertkblink}" class="btn btn-default btn-sm" onclick="window.open('supportticketskbarticle.php','kbartwnd','width=500,height=400,scrollbars=yes')" />
</div>
...
{if $userid}<tr><td class="fieldlabel">{$_ADMINLANG.support.addbilling}</td><td class="fieldarea"><div class="form-inline"><input type="text" name="billingdescription" size="50" placeholder="{$_ADMINLANG.support.toinvoicedes}" class="form-control" /> @ <input type="text" name="billingamount" size="10" placeholder="{$_ADMINLANG.fields.amount}" class="form-control" /> <select name="billingaction" class="form-control select-inline">
...
<textarea name="message" id="replymessage" rows="14" class="form-control"></textarea>
