...
`lastname` TEXT COLLATE utf8_general_ci NOT NULL ,
`companyname` TEXT COLLATE utf8_general_ci NOT NULL ,
`email` TEXT COLLATE utf8_general_ci NOT NULL ,
`address1` TEXT COLLATE utf8_general_ci NOT NULL ,
`address2` TEXT COLLATE utf8_general_ci NOT NULL ,
`city` TEXT COLLATE utf8_general_ci NOT NULL ,
`state` TEXT COLLATE utf8_general_ci NOT NULL ,
`postcode` TEXT COLLATE utf8_general_ci NOT NULL ,
`country` TEXT COLLATE utf8_general_ci NOT NULL ,
`phonenumber` TEXT COLLATE utf8_general_ci NOT NULL ,
`subtotal` DECIMAL( 10, 2 ) NOT NULL ,
`tax1` DECIMAL( 10, 2 ) NOT NULL ,
`tax2` DECIMAL( 10, 2 ) NOT NULL ,
`total` DECIMAL( 10, 2 ) NOT NULL ,
`customernotes` TEXT COLLATE utf8_general_ci NOT NULL ,
`adminnotes` TEXT COLLATE utf8_general_ci NOT NULL ,
...
`description` TEXT COLLATE utf8_general_ci NOT NULL ,
`quantity` TEXT COLLATE utf8_general_ci NOT NULL ,
