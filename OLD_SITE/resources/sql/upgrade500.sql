...
CREATE TABLE IF NOT EXISTS `tblbundles` (
  ...
  `itemdata` text COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblmodulelog` (
  ...
  `module` text COLLATE utf8_general_ci NOT NULL,
  `action` text COLLATE utf8_general_ci NOT NULL,
  `request` text COLLATE utf8_general_ci NOT NULL,
  `response` text COLLATE utf8_general_ci NOT NULL,
  `arrdata` text COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
