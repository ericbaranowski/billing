...
`prefix` TEXT COLLATE utf8_general_ci NOT NULL ,
`suffix` TEXT COLLATE utf8_general_ci NOT NULL ,
...
CREATE TABLE IF NOT EXISTS  `tblclientgroups` (
  ...
  `susptermexempt` text COLLATE utf8_general_ci,
  PRIMARY KEY  (`id`)
) DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
`departments` TEXT COLLATE utf8_general_ci NOT NULL ,
`statuses` TEXT COLLATE utf8_general_ci NOT NULL ,
`priorities` TEXT COLLATE utf8_general_ci NOT NULL ,
`timeelapsed` INT( 5 ) NOT NULL ,
`newdepartment` TEXT COLLATE utf8_general_ci NOT NULL ,
`newpriority` TEXT COLLATE utf8_general_ci NOT NULL ,
`newstatus` TEXT COLLATE utf8_general_ci NOT NULL ,
`flagto` TEXT COLLATE utf8_general_ci NOT NULL ,
`notify` TEXT COLLATE utf8_general_ci NOT NULL ,
`addreply` TEXT COLLATE utf8_general_ci NOT NULL
) DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
