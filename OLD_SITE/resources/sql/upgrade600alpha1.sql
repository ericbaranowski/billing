...
-- Add datetimes to mail templates.
-- Set utf8_unicode_ci collation to existing mail templates.
ALTER TABLE `tblemailtemplates`
  ADD `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `plaintext`,
  ADD `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `created_at`;

-- Add datetimes to configuration entries.
...
ALTER TABLE `tblconfiguration`
  ...
  ADD `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `value`,
  ADD `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `created_at`;

ALTER TABLE `tblconfiguration` DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Add datetimes to clients.
-- Set utf8_unicode_ci collation to existing clients.
ALTER TABLE `tblclients`
  ADD `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `overrideautoclose`,
  ADD `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER `created_at`;

-- Add datetimes to network issues.
ALTER TABLE `tblnetworkissues` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblnetworkissues` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS `tblserversssoperms` (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS `tblknowledgebasetags` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- Add datetimes to products.
ALTER TABLE `tblproducts` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblproducts` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
...
-- Add datetimes to product groups.
ALTER TABLE `tblproductgroups` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblproductgroups` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to downloads.
ALTER TABLE `tbldownloads` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tbldownloads` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to download categoriess.
ALTER TABLE `tbldownloadcats` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tbldownloadcats` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
...
-- Add datetimes to domains
ALTER TABLE `tbldomains` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tbldomains` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tbldomainsadditionalfields` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tbldomainsadditionalfields` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to services
ALTER TABLE `tblhosting` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblhosting` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to announcements
ALTER TABLE `tblannouncements` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblannouncements` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
...
-- Add datetimes to service addons
ALTER TABLE `tblhostingaddons` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblhostingaddons` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to client contacts
ALTER TABLE `tblcontacts` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblcontacts` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to cancellation requests
ALTER TABLE `tblcancelrequests` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblcancelrequests` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to quote items
ALTER TABLE `tblquoteitems` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblquoteitems` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to affiliates
ALTER TABLE `tblaffiliates` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tblaffiliates` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';

-- Add datetimes to security questions
ALTER TABLE `tbladminsecurityquestions` ADD COLUMN `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
ALTER TABLE `tbladminsecurityquestions` ADD COLUMN `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';
