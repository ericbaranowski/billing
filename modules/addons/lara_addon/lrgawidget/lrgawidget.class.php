...
class lrgawidget{
	...
	public function getPages(){
		$this->params = array('dimensions' => 'ga:pagePath');		
		$this->doCall(true);
	}	
	...
	## Helper Methods
	public function setProfileID($account_id, $property_id, $profile_id, $scp_url){
	...
	private function calculateTotals(){
		if (isset($this->results['rows'])){
			$totalSessions = $this->results['totalsForAllResults']['ga:sessions'];
	...
	private function jsonOutput(){
		...
		//$this->output['json_query'] = $this->currentQueryParams;
		//$this->output['json_queryID'] = $this->mdCurrentQueryParams;
		//$this->output['session'] = $_SESSION;
		//$this->output['db_settings'] = $this->store->getSettingsArray();
