...
$_LANG['pwresetvalidationsent'] = "На вашата е-пошта испратена Ви е порака за верификација.";
$_LANG['pwresetvalidationcheckemail'] = "Процесот за обнова на корисничката лозинка започна. Ве молиме проверете ја вашата е-пошта за понатамошни инструкции и верификација.";
...
$_LANG['newsletterunsubscribe'] = "Одјавете се од нашиот Е-информатор";
...
$_LANG['twofasetup'] = "Два начина на верификација на процесот";
...
$_LANG['twofaactivationcomplete'] = "Дво-степен фактор за проверка на автентичност Поставувањето е завршено!";
...
$_LANG['twoiptimebasedpassword'] = "Едно временска лозинка";
$_LANG['twoiptimebasedexplain'] = "Оваа опција за автентичност користи временска лозинка.  За генерирање на лозинка може да ја користите мобилната апликација. Доколку немате апликација, Ви ја препорачуваме Google Authenticator која е достапна за iOS, Android и Windows.";
$_LANG['twoipconfigureapp'] = "Сетирање на мобилната апликација за автентичност:";
$_LANG['twoipconfigurestep1'] = "Започнете со селектирање и додавање на нов токен";
$_LANG['twoipconfigurestep2'] = "Користете ја вашата мобилна апликација за скенирање на баркодот подолу, или мануелно впишете го овој сигурносен код: ";
...
$_LANG['domainsExpiringInMoreThan180Days'] = "Повеќе од 180 дена";
