...
$_LANG['affiliateswithdrawalrequestsuccessful'] = "O seu pedido de levantamento foi recebido. Entraremos em contato em breve.";
...
$_LANG['cartdomainsconfigdesc'] = "Poderá configurar os domínios no seu carrinho de compras em baixo. Aqui pode definir os serviços adicionais, as informações de contato e os servidores DNS.";
...
$_LANG['invoicestransnonefound'] = "Não foram encontradas transações";
...
$_LANG['ordercompletebutnotpaid'] = "Seu pedido foi efectuado e sua conta já se encontra activa. Para finalizar, é necessário que<br />efectue o pagamento. Clique no link abaixo para ver sua fatura e efectuar o pagamento.";
...
$_LANG['enomfrregistration']['EU Non-French Companies']['Name'] = "Empresa Europeias não Francesas";
...
$_LANG['unableToLoadShoppingCart'] = "Não foi possível carregar o carrinho de compras, por favor contate o suporte.";
...
$_LANG['insufficientstockmessage'] = "O nosso stock esta baixo. Por favor verifique mais tarde ou contate o nosso suporte.";
...
$_LANG['oauth']['badTwoFactorAuthModule'] = "Modulo de autenticação de 2 passos incompatível. Por favor contate o suporte.";
