...
$_LANG['clientareacontactsemails'] = "Préférences email";
$_LANG['clientareacontactsemailsdomain'] = "Emails noms de domaines - Avis de renouvellement, Confirmation d'enregistrement, etc.";
$_LANG['clientareacontactsemailsgeneral'] = "Emails généraux - Annonces & rappels de mots de passe";
$_LANG['clientareacontactsemailsinvoice'] = "Emails de facturation  - Facturation et rappels";
$_LANG['clientareacontactsemailsproduct'] = "Emails produits  - Détails de commande, messages de bienvenue, etc.";
$_LANG['clientareacontactsemailssupport'] = "Emails de support - Autorise l'utilisateur à ouvrir des demandes de support";
...
$_LANG['clientareaemailsintrotext'] = "Ci-dessous se trouve l'historique des emails que nous vous avons fait parvenir. Vous pourrez les consulter facilement où cas où vous les auriez égarés.";
...
$_LANG['clientareaerrorbannedemail'] = "Les utilisateurs utilisant ce fournisseur d'email ne sont pas autorisés sur ce site. Essayez une autre adresse de email.";
...
$_LANG['creditcardconfirmation'] = "Merci! Vos informations ont été acceptées et le premier paiement a été fait avec succès. Un email de confirmation vous a été envoyé.";
...
$_LANG['domainemailforwardingdesc'] = "Si le serveur de redirection des emails détermine que la redirection est invalide, nous désactiverons l'enregistrement de redirection automatiquemment. Veuillez vérifier l'adresse de redirection avant de la réactiver. Les modifications d'une redirection existante peuvent prendre jusqu'à 1 heure avant de prendre effet.";
...
$_LANG['invoiceofflinepaid'] = "Le paiement hors ligne par carte de crédit est fait manuellement. Lorsque votre paiement aura été fait, vous recevrez un email.";
...
$_LANG['loginincorrect'] = "Adresse de email ou mot de passe incorrects. Veuillez essayer à nouveau.";
$_LANG['loginintrotext'] = "Connection requise pour accéder à cette page. Les identifiants (nom d'utilisateur et mot de passe) de connection sont différents de ceux utilisés pour accéder à la section administrative du panneau de configuration de votre site Web.";
...
$_LANG['maxmind_rejectemail'] = "Nous n'acceptons pas les commandes utilisant une adresse email gratuite. Veuillez inscrire une autre adresse de email.";
...
$_LANG['orderreceived'] = "Merci pour votre commande. Un email de confirmation vous parviendra bientôt.";
...
$_LANG['pwdoesnotmatch'] = "Les mot de passe ne correspondent pas";
...
$_LANG['sslcertapproveremail'] = "Adresse email du responsable de ce certificat";
$_LANG['sslcertapproveremaildetails'] = "Vous devez choisir parmi les options ci-dessous où vous souhaitez que le email d'approbation de ce certificat soit envoyé.";
...
$_LANG['sslconfigcompletedetails'] = "La configuration de ce certificat est maintenant terminée et a été envoyé à l'autorité de certification pour validation. Vous devriez recevoir un email sous peu pour approbation.";
$_LANG['sslconfsslcertificate'] = "Configuration du Certificat SSL.";
$_LANG['sslcsr'] = "CSR";
$_LANG['sslerrorapproveremail'] = "Vous devez entrer l'adresse email du responsable de ce certificat";
...
$_LANG['sslserverinfodetails'] = "Vous devez avoir une requête de signature de certificat (CSR) valide afin de pouvoir configurer votre ceftificat SSL. Le CSR est un texte encrypté généré par le serveur web où le certificat sera installé. Si vous n'avez pas votre CSR, vous devez le générer ou demander à votre hébergeur de le générer pour vous. Assurez vous également de l'exactitude des informations entrées, car elles ne peuvent être changés après le déploiement du certificat.";
...
$_LANG['supportticketinvalid'] = "Une erreur est survenue. Cette demande de support n'a pu être trouvé.";
...
$_LANG['supportticketserrornoemail'] = "Vous n'avez pas inscrit votre adresse email";
...
$_LANG['supportticketssystemdescription'] = "Notre système de demande de support nous permet de répondre à vos demandes d'aide le plus rapidement possible. Lorsqu'une réponse est disponible, un email vous en avisera immédiatement.";
$_LANG['supportticketsticketattachments'] = "Pièce(s) jointe(s)";
$_LANG['supportticketsticketcreated'] = "Demande créée";
$_LANG['supportticketsticketcreateddesc'] = "Votre demande de support a été créé avec succès. Un email avec les détails de votre demande vous a été expédié. Si vous désirez consultez votre demande vous pouvez le faire dès à présent.";
...
$_LANG['pwresetdesc'] = "Vous pouvez réinitialiser votre mot de passe si vous l'avez oublié. Une fois votre adresse email saisie (et après avoir répondu à la question de sécurité si elle est activée), vous allez recevoir par email les instruction pour procéder à la réinitialisation de votre mot de passe.";
$_LANG['pwresetemailrequired'] = "Vous n'avez pas entré votre adresse email";
$_LANG['pwresetemailnotfound'] = "Aucun compte client ne correspond à l'adresse email saisie";
...
$_LANG['pwresetvalidationcheckemail'] = "La réinitialisation de votre mot de passe à débuté. Merci de consulter vos emails afin de poursuivre la procédure.";
...
$_LANG['masspayselected'] = "Payer les factures sélectionné(s)";
...
$_LANG['domainemailforwardinglaunch'] = "Lancer le gestionnaire de transfert des emails";
...
$_LANG['noquotes'] = "Il n'y a pas de devis présentes dans votre compte.<br />Pour demander un devis, veuillez S.V.P. contacter le service à la clientèle.";
...
$_LANG['cartdomainsconfiginfo'] = "Les options et les paramètres suivants sont disponibles pour les domaines que vous avez choisi. Les champs requis sont indiqués d'un astérisque (*).";
...
$_LANG['cartnameserverchoicecustom'] = "Utiliser des serveurs de noms personnalisé";
...
$_LANG['nschoicecustom'] = "Utiliser des serveurs de noms personnalisé (inscrire ci-dessous)";
...
$_LANG['domainbulkmanagementchangeaffect'] = "La modifications apportée ci-dessous auront une incidence sur les domaines suivants:";
...
$_LANG['captchaverifyincorrect'] = "Les caractères que vous avez saisi ne correspondent pas à l'image affichée. S'il vous plaît veuillez essayez de nouveau.";
...
$_LANG['bundlewarningdomainreq'] = "L'ensemble sélectionné requiert que vous enregegistriez ou transferiez un nom de domaine avec le produit %s pour être applicable";
...
$_LANG['domaininfoexp'] = "A droite vous trouverez les détails de votre nom de domaine. Vous pouvez gérer votre nom de domaine en utilisant les onglets ci-dessus.";
...
$_LANG['sslprovisioningdate'] = "Date de d'approvisionnement SSL";
...
$_LANG['domainaddonsemailforwardinginfo'] = "Ayez vos emails transférés à une adresse de votre choix afin de pouvoir les gérer depuis un seul compte.";
...
$_LANG['feedbackprovided'] = "Vous avez déjà fournis vos commentaires sur cette demande de support.";
...
$_LANG['twofaactivationerror'] = "Une erreur s'est produite lors de la tentative d'activation de l'authentification à deux facteurs pour votre compte. Veuillez s'il vous plaît essayez de nouveau.";
$_LANG['twofamoduleerror'] = "Une erreur s'est produite pendant le chargement du module. Veuillez s'il vous plaît essayez de nouveau.";
...
$_LANG['twofabackupcodeexpl'] = "Écrivez le sur un papier et gardez le en sécurité.<br />Il vous sera nécessaire si jamais vous perdez votre second facteur de sécurité ou s'il n'est pas disponible.";
...
$_LANG['twofageneralerror'] = "Une erreur est survenu lors du chargement du module. Veuillez essayer de nouveau.";
...
$_LANG['domainssuggestionswarnings'] = "Les suggestions de nom de domaine peuvent ne pas toujours êtres disponibles. La disponibilité est vérifiée en temps réel au moment de l'ajouter à votre panier.";
...
$_LANG['clientareaemaildesc'] = "Historique des emails que nous vous avons envoyés";
...
$_LANG['logoutandreturntoadminarea'] = "Déconnexion & retourà l'administration";
...
$_LANG['pwresetemailneeded'] = "Vous avez oublié votre mot de passe ? Veuillez entrer votre adresse email pour initier la réinitialisation.";
...
$_LANG['cPanel']['usageLastUpdated'] = "Dernière mises à jour";
...
$_LANG['orderForm']['personalInformation'] = "Informations personelles";
...
$_LANG['orderForm']['domainAlternativeContact'] = "Vous pouvez spécifier des informations de contact différente pour l'enregistrement du nom de domaine si vous placez une commande pour une autre personne ou entité. Si ce n'est pas le cas, vous pouvez sauter cette section.";
...
$_LANG['orderForm']['errorNoProducts'] = "Le groupe de produits ne contiens pas de produits visibles";
...
$_LANG['sso']['summary'] = "Des applications tierces tirent partis de la fonctionnalité de connexion unique pour vous fournir un accès direct à votre compte de facturation sans avoir à vous ré-authentifier.";
...
$_LANG['sso']['enabled'] = "La connexion unique est actuellement activé pour votre compte.";
$_LANG['sso']['disabled'] = "La connexion unique est actuellement désactivé pour votre compte.";
...
$_LANG['oauth']['permAccessNameAndEmail'] = "Accéder à votre nom et adresse email";

$_LANG['errorButTryAgain'] = "Une erreur est survenue. Veuillez essayer de nouveau.";
$_LANG['emailSent'] = "Email envoyé";
$_LANG['verificationKeyExpired'] = "La clé de vérification de cet email a expirée. Merci de vous reconnecter pour en générer une nouvelle.";
$_LANG['emailAddressVerified'] = "Merci d'avoir confirmé votre adresse email.";
$_LANG['emailKeyExpired'] = "La clé de vérification de cet email a expirée. Merci d'en demander une nouvelle.";
$_LANG['verifyEmailAddress'] = "Merci de vérifier votre boîte email et d'ouvrir le mail correspondant pour vérifier votre email.";
...
$_LANG['oauth']['currentlyLoggedInAs'] = "Vous êtes actuellement connécté comme :firstName :lastName";
...
$_LANG['orderForm']['suggestedDomains'] = "Domaines sugérés";
...
$_LANG['orderForm']['authCodeTooltip'] = "Pour initier ce transfert, vous avez besoin d'un code que vous pouvez obtenir gratuitement auprès de votre bureau d'enregsitrement actuel. Ce code est communément désigné comme EPP code ou Auth code. Il agit comme un mot de passe et est unique à chaque nom de domaine.";
...
$_LANG['orderForm']['transferUnlockBeforeContinuing'] = "Merci de vous assurer que vous avez déverouillé votre domaine chez votre bureau d'enregsitrement actuel avant de continuer.";
...
$_LANG['orderForm']['domainPriceTransferLabel'] = "Transférez ches nous et renouveller pour 1 an*";
...
$_LANG['clientHomePanels']['showingRecent100'] = "Afficher les 100 enregistrement les plus récents";
