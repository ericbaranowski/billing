...
/* Smarty version 3.1.29, created on 2017-01-10 20:54:39
  from "/home/billing/public_html/admin/templates/v4/menu.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58754a0f72efc4_26192867',
  'file_dependency' => 
  array (
    '5ca72e9f2db650ea5566d8e967d331f6f883e74f' => 
    array (
      0 => '/home/billing/public_html/admin/templates/v4/menu.tpl',
      1 => 1481721244,
      2 => 'file',
    ),
  ),
...
function content_58754a0f72efc4_26192867 ($_smarty_tpl) {
...
?>
<li><a href="index.php" title="Home"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['home']['title'];?>
</a>
  <ul>
    <li><a href="index.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['hometitle'];?>
</a></li>
    <li><a href="myaccount.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['myaccount'];?>
</a></li>
    <li><a href="logout.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['global']['logout'];?>
</a></li>
  </ul>
</li>
<li><a <?php if (in_array("List Clients",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="clients.php"<?php }?> title="Clients" id="Menu-Clients"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clients']['title'];?>
</a>
  <ul>
    <?php if (in_array("List Clients",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a href="clients.php" id="Menu-Clients-View_Search_Clients"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clients']['viewsearch'];?>
</a></li><?php }?>
    <?php if (in_array("Add New Client",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a href="clientsadd.php" id="Menu-Clients-Add_New_Client"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clients']['addnew'];?>
</a></li><?php }?>
    <?php if (in_array("List Services",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>
    <li class="expand"><a href="clientshostinglist.php" id="Menu-Clients-Products_Services"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['services']['title'];?>
</a>
        <ul>
...
<li><a id="Menu-Orders" <?php if (in_array("View Orders",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="orders.php"<?php }?> title="Orders"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['orders']['title'];?>
</a>
  <ul>
...
<li><a id="Menu-Billing" <?php if (in_array("List Transactions",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="transactions.php"<?php }?> title="Billing"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['billing']['title'];?>
</a>
  <ul>
...
<li><a id="Menu-Support" <?php if (in_array("Support Center Overview",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="supportcenter.php"<?php }?> title="Support"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['title'];?>
</a>
  <ul>
    <?php if (in_array("Manage Announcements",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Support-Annoucements" href="supportannouncements.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['announcements'];?>
</a></li><?php }?>
...
<?php if (in_array("View Reports",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Reports" title="Reports" href="reports.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['reports']['title'];?>
</a>
  <ul>
...
<li><a id="Menu-Utilities" title="Utilities" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['title'];?>
</a>
  <ul>
...
<li><a id="Menu-Addons" title="Addons" href="addonmodules.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['addonmodules'];?>
</a>
    <ul>
        <?php
...
<li><a id="Menu-Setup" title="Setup" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['setup']['title'];?>
</a>
  <ul>
...
<li><a id="Menu-Help" title="Help" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['title'];?>
</a>
  <ul>
